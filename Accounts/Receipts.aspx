<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receipts.aspx.cs" Inherits="fee_management_Receipts" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td><asp:Label ID="lbltitle" runat="server" Text="Receipts" CssClass="title_label"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table cellpadding="7" cellspacing="0" border="0">
                                                        ...
                                                        <tr id="trstd" runat="server">
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drpstandard" runat="server" Height="26px" 
                                                                     Width="180px" AutoPostBack="True" 
                                                                    onselectedindexchanged="drpstandard_SelectedIndexChanged"></asp:DropDownList>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right"></td>
                                                            <td style="width: 200px; height: 40px" align="left"></td>
                                                        </tr>
                                                        <tr id="trsec" runat="server">
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drpsection" runat="server" Height="26px" AutoPostBack="true" 
                                                                     Width="180px" onselectedindexchanged="drpsection_SelectedIndexChanged"></asp:DropDownList>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr id="trdept" runat="server">
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drpdept" runat="server" Height="26px" 
                                                                     Width="180px" AutoPostBack="true" 
                                                                    onselectedindexchanged="drpdept_SelectedIndexChanged"></asp:DropDownList>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                        <tr id="trdesig" runat="server">
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drpdesignation" runat="server" Height="26px" 
                                                                     Width="180px" AutoPostBack="true" 
                                                                    onselectedindexchanged="drpdesignation_SelectedIndexChanged"></asp:DropDownList>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr id="trledger2" runat="server">
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drptoledger" runat="server" Height="26px" 
                                                                     Width="180px" AutoPostBack="True" 
                                                                    onselectedindexchanged="drptoledger_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:Button ID="btnSave" runat="server" CssClass="s_button" Text="Receipt" 

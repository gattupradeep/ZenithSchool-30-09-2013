<%@ Page Language="C#" AutoEventWireup="true" CodeFile="view_student_examschedule.aspx.cs" Inherits="exam_view_student_examschedule" %>
...
<head id="Head1" runat="server">
	...
	<script type="text/javascript">
	    ...
	    function closeModal() {
	        ...
	        //window.parent.location = "view_student_examschedule.aspx";
	    }
    </script>
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="app_container_auto">
                                            ...
                                            <tr id="trexamgrid" runat="server">
                                                <td style=" height:20px;" align="left">
                                                    ...
                                                    onitemdatabound="dgexam_ItemDataBound" oneditcommand="dgexam_EditCommand">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vendormaster.aspx.cs" Inherits="Inventory_Vendor_Master" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td class="title_label">&nbsp;Vendor Master</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtname" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblconperson" runat="server" CssClass="s_label" 
                                                                    Text="Contact Person"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtconperson" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblmobileno" runat="server" CssClass="s_label" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 150px; height: 40px" align="right"> 
                                                             <%--<asp:RegularExpressionValidator ID="phonevalidate" runat="server" ControlToValidate="txtphone"
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblmailid" runat="server" CssClass="s_label" 
                                                                    Text="Mail Id"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtmailid" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right"> 
                                                            <asp:RegularExpressionValidator id="mailid" runat="server" ControlToValidate="txtmailid" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:Button ID="btnSave" runat="server" CssClass="s_button" Text="Save" 
                                                                    Width="60px" onclick="btnSaveClick"/>
                                                                &nbsp;
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <asp:DataGrid ID="grdvendor" runat="server" AutoGenerateColumns="False" 
                                                        OnDeleteCommand="grdvendor_DeleteCommand" OnEditCommand="grdvendor_EditCommand" 
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item"/>
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intid" HeaderText="intid" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strvendorname" HeaderText="Vendor Name">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strcontactperson" HeaderText="Contact Person">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="straddress" HeaderText="Address"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strmobileno" HeaderText="Mobile"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strphoneno" HeaderText="Phone"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strmailid" HeaderText="Mail"></asp:BoundColumn>

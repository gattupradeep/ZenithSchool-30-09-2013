<%@ Page Language="C#" AutoEventWireup="true" CodeFile="iteminward.aspx.cs" Inherits="Inventory_iteminward1" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        $(function() {
        var dates = $("#txtinwarddate").datepicker({
                constrainDates: true,
                dateFormat: 'yy/mm/dd',
                changeMonth: true,
                changeYear: true
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td class="title_label">&nbsp;Items Inward</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table cellpadding="5" cellspacing="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="left">
                                                                <asp:Label ID="lblinwarddate" runat="server" CssClass="s_label" 
                                                                    Text="Inward Date"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtinwarddate" runat="server" CssClass="s_textbox" 
                                                                    Width="180px" ></asp:TextBox>
                                                                    <%--<ajaxtoolkit:CalendarExtender ID="Calendar" runat="server" CssClass="cal_Theme1" Format="yyyy/MM/dd" PopupButtonID="txtinwarddate" TargetControlID="txtinwarddate"></ajaxtoolkit:CalendarExtender >--%>
                                                             </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <asp:DataGrid ID="grditeminward" runat="server" AutoGenerateColumns="False" 
                                                        OnDeleteCommand="grditeminward_DeleteCommand" OnEditCommand="grditeminward_EditCommand" 
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item"/>
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="id" HeaderText="intid" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strvendorname" HeaderText="Supplier">
                                                            </asp:BoundColumn>
                                                            ...
                                                            <asp:BoundColumn DataField="dtinwarddate" HeaderText="Inward Date" Visible="false">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intnoofitems" HeaderText="No Of Item">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intcategory" HeaderText="Cat" Visible="False">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intitemid" HeaderText="item" Visible="False">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="inwarddate" HeaderText="InwardDate" Visible="true"></asp:BoundColumn>

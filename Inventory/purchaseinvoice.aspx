<%@ Page Language="C#" AutoEventWireup="true" CodeFile="purchaseinvoice.aspx.cs" Inherits="Inventory_vendor" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left">Purchase Invoice</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td class="title_label">&nbsp;Purchase Invoice</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtinvoicedate" runat="server" CssClass="s_textbox" 
                                                                    Width="180px" ></asp:TextBox>
                                                                    <ajaxtoolkit:CalendarExtender ID="Calendarextender2" runat="server" CssClass="cal_Theme1" Format="yyyy/MM/dd" PopupButtonID="txtinvoicedate" TargetControlID="txtinvoicedate"></ajaxtoolkit:CalendarExtender ></td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblgrandtotal" runat="server" CssClass="s_label" 
                                                                    Text="Grand Total"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtgrandtotal" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                ...
                                                <td align="left">
                                                    <asp:DataGrid ID="grdvendor" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="invoicedate" HeaderText="InvoiceDate" Visible="true"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strsuppliername" HeaderText="Supplier Name"></asp:BoundColumn>
                                                            ...
                                                            <asp:BoundColumn DataField="numgrandtotal" HeaderText="Grand Total"></asp:BoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sellitems.aspx.cs" Inherits="Inventory_sellitemsnew" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Sell Items</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <table cellpadding="5" cellspacing="0" border="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtbillno" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="left">
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drppatron" runat="server" Height="26px" 
                                                                    ...
                                                                    onselectedindexchanged="drppatron_SelectedIndexChanged">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:DropDownList ID="drpitems" runat="server" Height="26px" 
                                                                     Width="180px" AutoPostBack="True" 
                                                                    onselectedindexchanged="drpitems_SelectedIndexChanged"></asp:DropDownList>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="left">
                                                                <asp:Label ID="lblavailable" runat="server" CssClass="s_label" 
                                                                    Text="Available Qty"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:Label ID="lblavailable1" runat="server" CssClass="s_label" 
                                                                    Text="Available Qty"></asp:Label>
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="lblquantity" runat="server" CssClass="s_label" 
                                                                    Text="Quantity"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtquantity" runat="server" CssClass="s_textbox" 
                                                                    Width="180px"></asp:TextBox>
                                                             </td>
                                                            <td align="right"></td>
                                                            <td align="left"></td>
                                                        ...
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:Button ID="btnSave" runat="server" CssClass="s_button" Text="Add" 
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="grdsellitems" runat="server" AutoGenerateColumns="False" 
                                                         Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                        ondeletecommand="grdsellitems_DeleteCommand" 
                                                        oneditcommand="grdsellitems_EditCommand">
                                             ...
                                             <tr>
                                                <td colspan="4">
                                                    <table cellpadding="5" cellspacing="0" border="0">
                                                        ...
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="left">
                                                                <asp:Label ID="lblgrand" runat="server" CssClass="s_label" 
                                                                    Text="Grand Total"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp; 
                                                                <asp:TextBox ID="txtgrand" runat="server" CssClass="s_textbox" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                ...
                                                                <asp:Button ID="btnDelete" runat="server" CssClass="s_button" Text="Paid" 
                                                                    Width="60px" onclick="btnDelete_Click" />
                                                            </td>
                                                            <td style="width: 150px; height: 40px" align="left">&nbsp;</td>
                                                            <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                                        </tr>

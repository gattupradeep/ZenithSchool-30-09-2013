<%@ Page Language="C#" AutoEventWireup="true" CodeFile="unitmaster.aspx.cs" Inherits="Inventory_unitmaster" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;&nbsp;Unit Master</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="lbl_uniname" runat="server" CssClass="s_label" Text="Unit Name"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txt_unitname" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="GrdunitMaster" runat="server" AutoGenerateColumns="False" 
                                                        OnDeleteCommand="dgboard_DeleteCommand" OnEditCommand="dgboard_EditCommand" 
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                        <ItemStyle CssClass="s_datagrid_item"/>
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intid" HeaderText="Unitid" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strunitname" HeaderText="Unit Name">
                                                            </asp:BoundColumn>

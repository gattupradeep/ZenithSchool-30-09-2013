<%@ Page Language="C#" AutoEventWireup="true" CodeFile="welcome.aspx.cs" Inherits="Inventory_welcome" %>
<%@ Register src="../usercontrol/topmenu.ascx" tagname="topmenu" tagprefix="uc2" %>
<%@ Register TagPrefix="cc1" Namespace="BunnyBear" Assembly="msgBox"%>
<%@ Register src="../usercontrol/topbanner.ascx" tagname="topbanner" tagprefix="uc3" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxtoolkit" %>
<%@ Register src="../usercontrol/admin_inventory.ascx" tagname="admin_inventory" tagprefix="uc1" %>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="230">
                                <tr>
                                    <td style="width: 230px" align="right">
                                        <uc1:admin_inventory ID="admin_inventory1" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                <td style="width: 710px; height: 400px" align="center">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_textbox" Font-Bold="True" 
                                                        Font-Size="30px" ForeColor="Red" Text="Welcome to Inventory Management"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cancelstaffleave.aspx.cs" Inherits="Leave_cancelstaffleave" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" >Cancel Staff&#39;s Leave</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container_auto">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="6"><asp:Label ID="lbltitle" runat="server" Text="Cancel Staff's Leave" CssClass="title_label"></asp:Label> </td>
                                            </tr>
                                            <tr>
                                                <td align="left" style="width: 125px;padding-left:10px; height: 40px">
                                            ...
                                            <tr>
                                                <td colspan="6" align="left" style="width:100%; height: 40px">
                                                            ...
                                                            <asp:TemplateColumn>
                                                                <ItemTemplate>
                                                                    <asp:Button id="btnreject"  runat="server" CausesValidation="false" 
                                                                        CssClass="s_grdbutton" CommandName="button" OnClientClick="return confirm ('Are you sure you want to cancel this record?')"
                                                    ...
                                                    <asp:Label ID="lblerror" runat="server" CssClass="s_label" 
                                                        Text="No Entries Found For Cancellation Request" Visible="False"></asp:Label>
                                                    </td>                                                
                                            </tr>
                                        </table>
                                    </td>

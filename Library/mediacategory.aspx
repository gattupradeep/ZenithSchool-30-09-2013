<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mediacategory.aspx.cs" Inherits="Library_mediacategory" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left"> Add / Edit Media Category</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                         ...
                                         <asp:UpdateProgress ID="Updateprocess" runat="server" AssociatedUpdatePanelID="updatepanal" DisplayAfter="1" >
                                           ...
                                           <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Add / Edit Media Category</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="medcat" runat="server" CssClass="s_label" Text="Media Category"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtmediacat" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtmediacat"></asp:RequiredFieldValidator>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="right">&nbsp;</td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:Button ID="btn1Save" runat="server" CssClass="s_button" Text="Save" 
                                                        Width="60px" onclick="btnSave_Click"/>
                                                    &nbsp;
                                                    <asp:Button ID="btn1Clear" runat="server" CssClass="s_button" Text="Clear" 
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="dgboard1" runat="server" AutoGenerateColumns="False" 
                                                        OnEditCommand="dgboard1_EditCommand" 

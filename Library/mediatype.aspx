<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mediatype.aspx.cs" Inherits="Library_mediatype" %>
                                    ...
                                    <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtmediatype" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtmediatype"></asp:RequiredFieldValidator>
                                                </td>

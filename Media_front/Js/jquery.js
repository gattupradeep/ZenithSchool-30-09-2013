...
;(function($){
	$.fn.msAccordion = function(options) {
		...
		allDivs.each(function(current) {
								 ...
								 var titleDiv = $(currentDiv).find("div.acc_title");
								 titleDiv.attr("id", sTitleID);
								 var contentDiv = $(currentDiv).find("div.acc_content");
		...
		function makeVertical() {
			...
			$("#"+elementid +" > div > div.acc_title").css({display:"block", float:"none", clear:"both"});
			$("#"+elementid +" > div > div.acc_content").css({clear:"both"});
		};
		function startPlay() {

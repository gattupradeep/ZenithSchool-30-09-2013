<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tutorial.aspx.cs" Inherits="Tutorials_Tutorial" %>
                                    ...
                                    <td style="width: 100%;" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                              <tr class="app_container_title">
                                                ...
                                                <td align="left">View Daily Class Notes</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;&nbsp;View Daily Class Notes</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" >
                                                    <table cellpadding="7" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="Label11" runat="server" CssClass="s_label" Text="Date"></asp:Label>
                                                           </td>
                                                            <td align="left">
                                                             <asp:TextBox ID="txtdate" runat="server" CssClass="s_textbox" AutoPostBack="true" 
                                                                    Width="150px" ontextchanged="txtdate_TextChanged"></asp:TextBox>
                                                                &nbsp;</td>
                                                            <td align="left">
                                                                <asp:Label ID="Label9" runat="server" CssClass="s_label" Text="Publish Date"></asp:Label>
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtpublishdate" runat="server" CssClass="s_textbox" AutoPostBack="true"
                                                                    Width="150px" ontextchanged="txtpublishdate_TextChanged"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr class="view_detail_subtitle_bg">
                                                            <td colspan="4" align="left">&nbsp;</td>
                                                        </tr>
                                                        <tr id="trdgtutorial" runat="server">
                                                            <td colspan="4" >

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Feemaster.aspx.cs" Inherits="school_Feemaster" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Fee Type</td>
                                            </tr>
                                              <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label2" runat="server" CssClass="s_label" Text="Fee Mode"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:DropDownList ID="ddlfeemode" runat="server" Width="150px" AutoPostBack="True" onselectedindexchanged="ddlfeemode_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Fee Type "></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtfee" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="dgfee" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        ondeletecommand="dgfee_DeleteCommand" oneditcommand="dgfee_EditCommand">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item"/>
                                                        <ItemStyle CssClass="s_datagrid_item"/>
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intID" HeaderText="ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strfeetype" HeaderText="Fee Type"></asp:BoundColumn>

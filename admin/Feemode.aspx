                                               ...
                                               <ContentTemplate> 
                                                <table cellpadding="7" cellspacing="0" border="0" class="app_container">
                                                    <tr class="view_detail_title_bg">
                                                        <td colspan="4"><asp:Label CssClass="title_label" ID="lbltit" runat="server" Text="Add Fee Mode" ></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 150px; height: 40px" align="left">
                                                            <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Fee Mode"></asp:Label>
                                                        </td>
                                                        <td style="width: 200px; height: 40px" align="left">
                                                            <asp:TextBox ID="txtfeemode" runat="server" CssClass="s_textbox"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 200px; height: 40px" align="left">
                                                            <asp:Button ID="btnSave" runat="server" CssClass="s_button" Text="Save"
                                                                Width="60px" OnClientClick="return Validatation();" onclick="btnSave_Click"/>
                                                            &nbsp;
                                                    ...
                                                    <tr>
                                                        <td colspan="4" align="right" style="width: 150px; height: 20px">
                                                            &nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" style="width: 500px; height: 40px" align="left">
                                                            <asp:DataGrid ID="dgfee" runat="server" AutoGenerateColumns="False" 
                                                                Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                                CellPadding="2" CellSpacing="1" oneditcommand="dgfee_EditCommand">
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:ButtonColumn ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" CommandName="edit" HeaderText="Edit"

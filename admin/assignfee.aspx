...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
       ...
       function SelectAll() {
        ...
        function Message() {
            alert("All Classes assigned for selected criteria");
        }
                                            ...
                                            <ContentTemplate>                                        
                                               <table cellpadding="7" cellspacing="0" border="0" class="app_container">
                                                    <tr class="view_detail_title_bg">
                                                        <td colspan="5" align="left" class="title_label">Assign fee </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 150px; height: 40px" align="left">
                                                            <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="AcademicYear"></asp:Label>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="width: 185px; height: 40px" align="left">
                                                            <asp:DropDownList ID="ddlfeemode" runat="server" onchange="uncheck();" Width="170px" Height="19px" AutoPostBack="true" 
                                                     ...
                                                     <tr>
                                                        ...
                                                        <asp:TextBox ID="txtstd" runat="server" CssClass="s_textbox" Width="170px" AutoComplete="off" onkeypress="return AvoidTyping();" onblur="return AvoidTyping();" OnClick="ValidateFeemode(); "></asp:TextBox>
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 400px" align="left" valign="top">
                                                                            <table>
                                                                                <tr>
                                                                                    <td style="width: 100%" align="left">
                                                                                        <asp:CheckBox ID="chkall" runat="server" Text="Select All" CssClass="s_button" OnClick="CheckAll(); " 
                                                                                         style="float:left;margin-left:3px;"/>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="width: 100%"  align="left">
                                                                                        <asp:CheckBoxList ID="ddlstandard" runat="server" RepeatColumns="3" OnClick= "GetSelectedItem();">
                                                                                        </asp:CheckBoxList>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                            ...
                                                            &nbsp;</td>
                                                        <td style="width: 185px; height: 40px" align="left">
                                                            <asp:HiddenField ID="lblSelectAll" runat="server" />
                                                         </td>
                                                        <td align="left">
                                                            <br />
                                                            <br />
                                                    ...
                                                    <tr>
                                                        <td style="width: 150px; height: 40px" align="left">
                                                            <asp:Label ID="lblAmount" runat="server" CssClass="s_label" Text="Amount"></asp:Label>
                                                        </td>
                                                        <td style="width: 185px; height: 40px" align="left">
                                                            <asp:TextBox ID="txtAmount" runat="server" CssClass="s_textbox" Width="170px" onkeypress="return validate(event)" OnClick="ValidateClass();"></asp:TextBox>
                                                        </td>
                                                        <td align="left" style="width:150px">
                                                            <asp:Label ID="lblEditID" runat="server" CssClass="s_label" Visible="false" Text="0"></asp:Label>
                                                        </td>
                                                        <td align="left"></td>
                                                        <td align="left"></td>
                                                    </tr>
                                                    <tr id="trbutton" runat="server">
                                                        ...
                                                        <td style="width: 185px; height: 40px" align="left">
                                                            <asp:Button ID="btnSave" runat="server" CssClass="s_button" Text="Save" 
                                                                Width="60px" OnClientClick="javascripts: return Validation(); " onclick="btnSave_Click" />
                                                            &nbsp;
                                                   ...
                                                   <tr id="trgrdview" runat="server">
                                                        <td colspan="5" align="left">
                                                            <asp:DataGrid ID="dgsetfee" runat="server" AutoGenerateColumns="False" 
                                                                AllowPaging="true" PageSize="15"  Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                                    CellPadding="4" CellSpacing="1" 
                                                                onpageindexchanged="dgsetfee_PageIndexChanged" oneditcommand="dgsetfee_EditCommand" >                                                            
                                                                    <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                    <ItemStyle CssClass="s_datagrid_item" />
                                                                        <Columns>
                                                                            <asp:BoundColumn DataField="AssignID" Visible="false" >                                                                                                                                                                                
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="FeemodeID" Visible="false" >                                                                                                                                                                                
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="FeemodeName" HeaderText="Fee Mode">
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="Class" HeaderText="Class">
                                                                            </asp:BoundColumn>
                                                                            <asp:BoundColumn DataField="FeeAmount" HeaderText="Fee Amount" >
                                                                            </asp:BoundColumn>

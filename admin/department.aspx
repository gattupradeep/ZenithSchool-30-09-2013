<%@ Page Language="C#" AutoEventWireup="true" CodeFile="department.aspx.cs" Inherits="admin_Admin_department" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left">Add / Edit Department</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Add / Edit Department</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Department Name:  "></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtdapartment" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="right">
                                                    <asp:RegularExpressionValidator ID="reg1" runat="server" 
                                                        ControlToValidate="txtdapartment" ErrorMessage="*" Height="16px" 
                                                        ValidationExpression="^[a-zA-Z''-'\s]{1,40}$" Width="16px"></asp:RegularExpressionValidator>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                        ControlToValidate="txtdapartment" ErrorMessage="*" Height="16px" Width="16px"></asp:RequiredFieldValidator>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="dgdepart" runat="server" AutoGenerateColumns="False" 
                                                         OnEditCommand="dgdepart_EditCommand" 
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item"/>
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intid" HeaderText="Department ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strdepartmentname" HeaderText="Department Name">
                                                            </asp:BoundColumn>

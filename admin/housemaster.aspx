<%@ Page Language="C#" AutoEventWireup="true" CodeFile="housemaster.aspx.cs" Inherits="admin_housemaster" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left"> Add / Edit House</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label" align="right">&nbsp;Add / Edit House</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label2" runat="server" CssClass="s_label" Text="House Name"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txthousename" runat="server" CssClass="s_textbox" 
                                                        Width="197px"></asp:TextBox>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                        ControlToValidate="txthousename" CssClass="s_label" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="House Color"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txthousecolor" runat="server" CssClass="s_textbox" 
                                                        Width="197px"></asp:TextBox>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                        ControlToValidate="txthousecolor" CssClass="s_label" ErrorMessage="*"></asp:RequiredFieldValidator>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left"></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="dghouse" runat="server" AutoGenerateColumns="False"  
                                                     OnEditCommand="dghouse_EditCommand" Width="100%" BorderStyle="None" 
                                                        BorderWidth="0px" GridLines="None">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intid" HeaderText="ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strhousename" HeaderText="House Name">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strhousecolor" HeaderText="House Color">
                                                            </asp:BoundColumn>

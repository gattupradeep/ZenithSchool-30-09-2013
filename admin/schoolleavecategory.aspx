<%@ Page Language="C#" AutoEventWireup="true" CodeFile="schoolleavecategory.aspx.cs" Inherits="Leave_schoolleavecategory" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left">Add / Edit School Leave Category</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Add / Edit School Leave Category</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Leave Type"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:DropDownList ID="ddlleavetype" runat="server" CssClass="s_textbox" 
                                                        Width="180px" AutoPostBack="True" 
                                                        onselectedindexchanged="ddlleavetype_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                    <asp:TextBox ID="txtleave0" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:Button ID="btnadd" runat="server" CssClass="s_button" 
                                                        Text="Add New Leave Type" onclick="btnadd_Click" />
                                                        <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="ddlleavetype" InitialValue="0" ErrorMessage="Please select Leave Type"></asp:RequiredFieldValidator>--%>                                                
                                                </td>
                                            </tr>
                                            <tr id="trpay" runat="server">
                                                <td style="height: 40px" align="left" colspan="2">&nbsp;
                                                    <asp:RadioButton ID="rbtpaid" runat="server" CssClass="s_label" 
                                                        Text="Paid" Checked="True" GroupName="paytype" />
                                                    <asp:RadioButton ID="rbtunpaid" runat="server" CssClass="s_label" 
                                                        Text="Unpaid" GroupName="paytype" />
                                                </td>
                                            ...
                                            <tr id="trdeduction" runat="server">
                                                <td style="width: 150px; height: 40px" align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="Label5" runat="server" CssClass="s_label" Text="Deduction"></asp:Label>
                                                </td>
                                                    <td  style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtdeduction" runat="server" CssClass="s_textbox" Width="180px">0</asp:TextBox>
                                                        &nbsp;<asp:Label 
                                                            ID="Label6" runat="server" CssClass="s_label" Text="%"></asp:Label></td>
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    &nbsp;</td>
                                                    <td  style="width: 200px; height: 40px" align="left">
                                                    <asp:Button ID="btnsubmit" runat="server" CssClass="s_button" Text="Save" 
                                            ...
                                            <tr id="trgrid" runat="server">
                                                <td colspan="4" style="height: 40px" align="left">
                                                    <asp:DataGrid ID="dgleavecat" runat="server" AutoGenerateColumns="False" 
                                                         OnEditCommand="dgleavecat_EditCommand" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="intpay" HeaderText="Pay" Visible="false"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strpaytype" HeaderText="Pay Type"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intdeduction" HeaderText="Deduction(%)">
                                                            </asp:BoundColumn>

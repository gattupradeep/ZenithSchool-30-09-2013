<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Welcome.aspx.cs" Inherits="admission_Welcome" %>
                                            ...
                                            <tr>
                                                <td style="width: 710px; height: 400px" align="center">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_textbox" Font-Bold="True" 
                                                        Font-Size="30px" ForeColor="Red" Text="Welcome to Main Masters"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="studentattendance.aspx.cs" Inherits="attendance_studentattendance" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" > Assign Student Attendance</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" class="app_container_auto" >
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="950">
                                                        <tr id="trdegree" runat="server">
                                                            <td align="left" style="width: 150px; height: 40px">
                                                             &nbsp;&nbsp;
                                                             <asp:Label ID="lbldegree" runat="server" CssClass="s_label" Text="Standard"></asp:Label>
                                                            </td>
                                                            ...
                                                            <td align="left" style="width: 150px; height: 40px">
                                                             <asp:Label ID="Label75" runat="server" CssClass="s_label" Text="HomeTeacher"></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 475px; height: 40px">
                                                             <asp:Label ID="lblhometeacher" runat="server" CssClass="s_label">Select Class & Section</asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="width: 150px; height: 40px">
                                                            ...
                                                            <td align="left" style="width: 475px; height: 40px">&nbsp;</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                            <tr id="trgrid" runat="server" visible="false">
                                                <td align="center" class="style1">
                                                    <asp:DataGrid ID="dgstudentattend" Width="100%" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Reason For Absent">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:TextBox ID="txtreason" runat="server" Width="250px" CssClass="s_textbox"></asp:TextBox>
                                                                </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                        </Columns>
                                                        <HeaderStyle CssClass="s_datagrid_header"/>
                                                    </asp:DataGrid>
                                                             <asp:Label ID="lblerror" runat="server" CssClass="s_label" 
                                                        Text="Students Not Assigned For The Selected Class & Section" Visible="false"></asp:Label>
                                                </td>
                                            </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="students_attendance_reports.aspx.cs" Inherits="detailsrecord_studentattendance_report" %>
                                    ...
                                    <td style="width: 100%; height: 50px" align="left">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                ...
                                                <td align="left" >Student's Attendance Search | View</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0"  class="curve" width="950">
                                                        <tr class="view_detail_subtitle_bg">
                                                            <td style="width: 950px; height: 40px; color: Black; font-weight: bold; padding-left: 10px" align="left" class="s_label">
                                                                ...
                                                                <asp:Label ID="lblsection" runat="server"></asp:Label>&nbsp;| Home Teacher :
                                                                <asp:Label ID="lblhometeacher" runat="server"></asp:Label> &nbsp; | Date :

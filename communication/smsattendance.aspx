<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsattendance.aspx.cs" Inherits="communication_smsattendance" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Attendance"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr >
                                                        ...
                                                        <tr>
                                                            <td valign="top" style="width:130px;" class="sms_template_lable">
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td align="left" style="width: 560px; height:auto">
                                                                <asp:Label ID="lblkeywords" runat="server" CssClass="sms_keyword_label" Height="100%" 
                                                                    Text=""></asp:Label>
                                                            </td>                                                
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" align="center" colspan="2"><asp:Label ID="Hiddenerror" runat="server" CssClass="nodatatodisplay"></asp:Label></td>
                                                        </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr id="trdgattendance" runat="server">
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgattendance" runat="server" width="100%" 
                                                                                AutoGenerateColumns="False" GridLines="None">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                    <asp:BoundColumn DataField="intstudent" HeaderText="ID" Visible="False"></asp:BoundColumn>
                                                                                    ...
                                                                                    <asp:BoundColumn DataField="stdsec" HeaderText="Class"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="dtdate" HeaderText="Date of Leave"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strsession" HeaderText="Session"></asp:BoundColumn>

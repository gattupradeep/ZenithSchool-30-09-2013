<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsbirthday.aspx.cs" Inherits="communication_smsbirthday" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            Sys.WebForms.PageRequestManager.getInstance().add_endRequest(EndRequestHandler);
            function EndRequestHandler(sender, args) {
                $('#txtfromdtdate').datepicker({ dateFormat: 'dd/mm/yy', changeMonth: true, changeYear: true });
            }
        });
        $(function() {
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Birthday"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblpatrontype" runat="server" Text="Patron Type" CssClass="sms_label"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlpatrontype" runat="server" CssClass="sms_label" AutoPostBack="true"
                                                                    width="150px" onselectedindexchanged="ddlpatrontype_SelectedIndexChanged">
                                                                    <asp:ListItem Value="-Select-">-Select-</asp:ListItem>
                                                                    <asp:ListItem Value="All">All</asp:ListItem>
                                                                    <asp:ListItem Value="Student">Student</asp:ListItem>
                                                                    <asp:ListItem Value="Teaching Staffs">Teaching Staffs</asp:ListItem>
                                                                    <asp:ListItem Value="Non Teaching Staffs">Non Teaching Staffs</asp:ListItem>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblfromdate" runat="server" Text="Date" CssClass="sms_label"></asp:Label>
                                                            </td>   
                                                            <td>
                                                               <asp:TextBox ID="txtfromdtdate" runat="server" CssClass="s_textbox" 
                                                                    ontextchanged="dtdate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                        <tr id="trmulticlass" runat="server" visible="false">
                                                            <td valign="top" class="sms_template_lable">
                                                        ...
                                                        <tr id="trkeywords" runat="server" visible="false">
                                                            ...
                                                            <td align="left" style="width: 550px; height:auto">
                                                        ...
                                                        <tr id="trconditionquery" runat="server" visible="false">
                                                            <td valign="top" colspan="4" align="center"><asp:Label ID="lblconditionquery" runat="server"></asp:Label></td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" colspan="4" align="center"><asp:Label ID="Hiddenerror" runat="server" CssClass="nodatatodisplay"></asp:Label></td>
                                                        </tr>
                                                        <tr id="trdggreeting" runat="server">
                                                            <td colspan="4" align="center" valign="top" style="width:100%">
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgbirthday" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <HeaderStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px">
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgbirthdaychkbox" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgbirthdaychkall" runat="server" Text="All" AutoPostBack="true"
                                                                                                oncheckedchanged="dgbirthdaychkall_CheckedChanged" />
                                                                                        </HeaderTemplate><HeaderStyle Width="30px"></HeaderStyle>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:BoundColumn HeaderText="ID" DataField="intid"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Name" DataField="name"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="DOB" DataField="dtdateofbirth"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Gender" DataField="strgender"></asp:BoundColumn>
                                                                                </Columns>
                                                                                <HeaderStyle CssClass="s_datagrid_header" />
                                                                            </asp:DataGrid>
                                                                        </td>   
                                                                    </tr>
                                                                    <tr id="trpatronall" runat="server" visible="false">
                                                                        <td colspan="4" valign="top" align="center">
                                                                            <asp:Label ID="patronallstud" runat="server" CssClass="sms_label"></asp:Label>
                                                                            <asp:Label ID="patrongallstaff" runat="server" CssClass="sms_label"></asp:Label>
                                                                        </td>
                                                                    </tr>

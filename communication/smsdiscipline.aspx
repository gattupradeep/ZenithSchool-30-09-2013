<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsdiscipline.aspx.cs" Inherits="communication_smsdiscipline" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Discipline"></asp:Label>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgdiscipline" runat="server" AutoGenerateColumns="false" Width="100%" GridLines="None">
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:BoundColumn HeaderText="StudentID" DataField="intstudent" Visible="false"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Name" DataField="studname" ></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Standard & Sec" DataField="stdandsec"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Date" DataField="dtdate"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Remarks" DataField="strdiscipline"></asp:BoundColumn>
                                                                                </Columns>

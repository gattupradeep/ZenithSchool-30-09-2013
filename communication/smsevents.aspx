<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsevents.aspx.cs" Inherits="communication_smsevents" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Events"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblevents" runat="server" CssClass="sms_label" Text="Events"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlevents" runat="server" CssClass="sms_label" AutoPostBack="true" 
                                                        ...
                                                        <tr id="trkeywords" runat="server" visible="false">
                                                            <td align="left" style="width: 150px;" valign="top" class="sms_template_lable">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgevent" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px" >
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgeventchkselect" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgeventchkselectall" runat="server"  Text="All" AutoPostBack="true" 
                                                                                                oncheckedchanged="dgeventchkselectall_CheckedChanged"/>
                                                                                        </HeaderTemplate>

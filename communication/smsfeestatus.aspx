<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsfeestatus.aspx.cs" Inherits="communication_smsfeestatus" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(function() {
        var dates = $("#txtfromdtdate").datepicker({
                constrainDates: true,
                dateFormat: 'dd/mm/yy',
                changeMonth: true,
                changeYear: true
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Fee Status"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr id="trdate" runat="server">
                                                            <td valign="top" style="width:115px" class="sms_template_lable">
                                                                <asp:Label ID="lblduetype" runat="server" Text="Status" CssClass="sms_label"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlfeestatus" runat="server" CssClass="s_dropdown" AutoPostBack="true" 
                                                                    onselectedindexchanged="ddlfeestatus_SelectedIndexChanged">
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable"><asp:Label ID="lblclass" runat="server" Text="Standard & Sec" CssClass="sms_label"></asp:Label></td>
                                                            <td><asp:DropDownList ID="ddlclass" runat="server" CssClass="s_dropdown" 
                                                                    onselectedindexchanged="ddlclass_SelectedIndexChanged" AutoPostBack="true" ></asp:DropDownList></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr id="trallgrids" runat="server">
                                                            <td colspan="2" align="center" valign="top" style="width:100%">
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="grdstudentfeedue" runat="server" AutoGenerateColumns="False"  
                                                                                ...
                                                                                <asp:TemplateColumn >
                                                                                    <HeaderTemplate>
                                                                                        <asp:CheckBox ID="chkall" runat="server" AutoPostBack="true" Text="ALL" 
                                                                                            Width="5%" oncheckedchanged="dgchkall_CheckedChanged" 
                                                                                            />
                                                                                    </HeaderTemplate>
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="dgchkselect" runat="server" AutoPostBack="true" Width="5%"/>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateColumn>
                                                                                    <asp:BoundColumn DataField="studentid" HeaderText="ID" Visible="False" >
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="intyear" HeaderText="Year" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="name" HeaderText="Name of Student" ItemStyle-Width="10%">
                                                                                        <ItemStyle Width="10%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strstandard" HeaderText="Class" ItemStyle-Width="8%" >                                                                                                                                                                                
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strfeemode" HeaderText="Fee Mode" ItemStyle-Width="11%">
                                                                                        <ItemStyle Width="11%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strfeetype" HeaderText="Fee Title" ItemStyle-Width="10%">
                                                                                        <ItemStyle Width="10%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="uptodate" HeaderText="Uptodate" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="duedate" HeaderText="Due Date" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="amount" HeaderText="Actual Amount" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="withlatefee" HeaderText="With Fine" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="paid" HeaderText="PaidAmount" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="balance" HeaderText="Balance" ItemStyle-Width="8%">
                                                                                        <ItemStyle Width="8%" />
                                                                                    </asp:BoundColumn>
                                                                                </Columns>
                                                                        ...
                                                                        <td align="center" valign="middle" class="s_datagrid_header">
                                                                            <table cellpadding="5" cellspacing="0" border="0" width="60%" style="text-align:center">
                                                                                ...
                                                                                <tr id="trdelaydate" runat="server" visible="false">
                                                                                    ...
                                                                                    <td>
                                                                                        <asp:Button ID="submitdelay" runat="server" Text="Submit" CssClass="s_button" onclick="submitdelay_Click" />
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </td>

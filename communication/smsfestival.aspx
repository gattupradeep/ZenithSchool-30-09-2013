<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsfestival.aspx.cs" Inherits="communication_smsfestival" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Festivals and Holidays"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblfestival" runat="server" CssClass="sms_label" Text="Festivals"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlfestivaltype" runat="server" CssClass="sms_label" AutoPostBack="true" 
                                                                    Width="150px" onselectedindexchanged="ddlfestivaltype_SelectedIndexChanged"></asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr id="trdgfestival" runat="server">
                                                            <td colspan="2" align="center" valign="top" style="width:100%">
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgfestival" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px" >
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgfestivalchkselect" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgfestivalchkselectall" runat="server"  Text="All" AutoPostBack="true" 
                                                                                                oncheckedchanged="dgfestivalchkselectall_CheckedChanged"/>
                                                                                        </HeaderTemplate>
                                                                                    ...
                                                                                    <asp:BoundColumn HeaderText="" DataField="classanddept"></asp:BoundColumn>

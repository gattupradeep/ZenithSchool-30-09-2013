<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsgeneral.aspx.cs" Inherits="communication_smsgeneral" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for General"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dggeneral" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%">
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px" >
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dggeneralchkselect" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dggeneralchkselectall" runat="server"  Text="All" AutoPostBack="true" 
                                                                                                oncheckedchanged="dggeneralchkselectall_CheckedChanged"/>
                                                                                        </HeaderTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smshomework.aspx.cs" Inherits="communication_smshomework" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Homework"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblsubject" runat="server" Text="Subject" CssClass="sms_label"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlsubject" runat="server" CssClass="sms_label" Width="150px" 
                                                                    onselectedindexchanged="ddlsubject_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" style="width: 600px; height:auto" >
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr id="trdgattendance" runat="server">
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dghomework" runat="server" width="100%" 
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <%--<asp:TemplateColumn HeaderStyle-Width="30px">
                                                                                        ...
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="chkSelectAll" runat="server" autopostback="true" Text="All" 
                                                                                                            oncheckedchanged="chkSelectAll_CheckedChanged" />
                                                                                        </HeaderTemplate>
                                                                                        <ItemStyle VerticalAlign="Top" />
                                                                                    </asp:TemplateColumn>--%>
                                                                                    <asp:BoundColumn DataField="strsubject" HeaderText="Subject"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strunit" HeaderText="Unit Name"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strlesson" HeaderText="Lesson Name"></asp:BoundColumn>
                                                                                    <asp:BoundColumn DataField="strtopic" HeaderText="Topic"></asp:BoundColumn>

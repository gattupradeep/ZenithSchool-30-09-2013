<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsleavemanagement.aspx.cs" Inherits="communication_smsleavemanagement" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Leave Status"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblleavestatus" runat="server" CssClass="sms_label" Text="Leave Status"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlleavestatus" runat="server" CssClass="sms_label" AutoPostBack="true" 
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr >
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgleavemngt" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                <asp:TemplateColumn>
                                                                                    <ItemTemplate>
                                                                                        <asp:CheckBox ID="dgleavemngtcheckbox" runat="server" />
                                                                                    </ItemTemplate>
                                                                                    <HeaderTemplate>
                                                                                        <asp:CheckBox ID="dgleavemngtchkall" runat="server" Text="All" AutoPostBack="true" 
                                                                                            oncheckedchanged="dgleavemngtchkall_CheckedChanged" />
                                                                                    </HeaderTemplate>
                                                                                </asp:TemplateColumn>
                                                                                    <asp:BoundColumn HeaderText="ID" DataField="intID" Visible="false"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Name" DataField="intstaff"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Date of Requested" DataField="dtdateofrequest"></asp:BoundColumn>
                                                                                </Columns>

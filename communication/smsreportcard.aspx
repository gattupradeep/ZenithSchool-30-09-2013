<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsreportcard.aspx.cs" Inherits="communication_smsreportcard" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Reportcard"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr id="trdgattendance" runat="server">
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgreportcard" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px">
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgreporcardchkselect" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgreportcardchkall" runat="server" Text="All" AutoPostBack="true" 
                                                                                                oncheckedchanged="dgreportcardchkall_CheckedChanged" />
                                                                                        </HeaderTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:BoundColumn HeaderText="ID" DataField="reportcarid" Visible="false"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Student ID" DataField="intstudent" Visible="false"></asp:BoundColumn>
                                                                        ...
                                                                        <td align="center" valign="middle" class="s_datagrid_header">
                                                                            <table cellpadding="5" cellspacing="0" border="0" width="60%" style="text-align:center">
                                                                                ...
                                                                                <tr id="trdelaydate" runat="server" visible="false">
                                                                                    <td>
                                                                                        <asp:Label ID="lbldelaydate" runat="server" Text="Delay Date :" CssClass="sms_label"></asp:Label>
                                                                                    </td>
                                                                                    <td align="left">

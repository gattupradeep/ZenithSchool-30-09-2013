<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smsstaffsubstitute.aspx.cs" Inherits="communication_smsstaffsubstitute" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Substitute"></asp:Label>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgstaffsubstitute" runat="server" AutoGenerateColumns="false" Width="100%" GridLines="None">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px">
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgchkselect" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgchkall" runat="server" Text="All" AutoPostBack="true" 
                                                                                                oncheckedchanged="dgchkall_CheckedChanged" />
                                                                                        </HeaderTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:BoundColumn HeaderText="ID" DataField="intid" Visible="false"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="StaffID" DataField="strteacher" Visible="false"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Name" DataField="staffname" ></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Standard & Sec" DataField="class"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Date" DataField="dtdate"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Day" DataField="strday"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Period" DataField="strperiod"></asp:BoundColumn>
                                                                                </Columns>

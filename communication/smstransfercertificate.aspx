<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smstransfercertificate.aspx.cs" Inherits="communication_smstransfercertificate" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Transfer Certificate"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lbltcstatus" runat="server" CssClass="sms_label" Text="TC Status"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddltcstatus" runat="server" CssClass="sms_label" AutoPostBack="true" Width="150px"
                                                                    onselectedindexchanged="ddltcstatus_SelectedIndexChanged">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr >
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgtc" runat="server" GridLines="None" AutoGenerateColumns="false" Width="100%">
                                                                                <ItemStyle CssClass="s_datagrid_item" />
                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                <Columns>  
                                                                                    <asp:TemplateColumn>
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgtcchkselect" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgtcchkall" runat="server" Text="All" AutoPostBack="true" 
                                                                                                oncheckedchanged="dgtcchkall_CheckedChanged" />
                                                                                        </HeaderTemplate>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:BoundColumn HeaderText="ID" DataField="intid" Visible="false" ></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="StudentID" DataField="int_studentid"></asp:BoundColumn>
                                                                                    ...
                                                                                    <asp:BoundColumn HeaderText="Requested Date" DataField="dt_dateOf_requestOfwithdrawal"></asp:BoundColumn>
                                                                                </Columns>

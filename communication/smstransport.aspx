<%@ Page Language="C#" AutoEventWireup="true" CodeFile="smstransport.aspx.cs" Inherits="communication_smstransport" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="3" border="0" width="61%" class="top_curve">
                                                        ...
                                                        <tr>
                                                            <td colspan="2" class="sms_template_lable" align="center">
                                                                <asp:Label ID="lbltitle" runat="server" CssClass="sms_header" Text="SMS for Transport"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblroutename" runat="server" Text="Route Name" CssClass="sms_label"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlroutename" runat="server" CssClass="sms_label" AutoPostBack="true"
                                                                    width="150px" onselectedindexchanged="ddlroutename_SelectedIndexChanged">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr >
                                                            <td valign="top" class="sms_template_lable">
                                                                <asp:Label ID="lblbusnumber" runat="server" Text="Bus Number" CssClass="sms_label"></asp:Label>
                                                            </td>   
                                                            <td>
                                                                <asp:DropDownList ID="ddlbusnumber" runat="server" CssClass="sms_label" Width="150px">
                                                                </asp:DropDownList>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr id="trkeywords" runat="server" visible="false">
                                                            ...
                                                            <td align="left" style=" height:auto" >
                                                                <asp:Label ID="lblkeywords" runat="server" CssClass="sms_keyword_label" Width="400px" Height="100%" 
                                                                    Text=""></asp:Label>
                                                            </td>                                                
                                                        </tr>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" align="center">
                                                                            <asp:DataGrid ID="dgtransport" runat="server" AutoGenerateColumns="false" GridLines="None" Width="100%">
                                                                                ...
                                                                                <Columns>
                                                                                    <asp:TemplateColumn HeaderStyle-Width="30px">
                                                                                        <ItemTemplate>
                                                                                            <asp:CheckBox ID="dgtransportchk" runat="server" />
                                                                                        </ItemTemplate>
                                                                                        <HeaderTemplate>
                                                                                            <asp:CheckBox ID="dgtransportchkall" runat="server" Text="All"  />
                                                                                        </HeaderTemplate><HeaderStyle Width="30px"></HeaderStyle>
                                                                                    </asp:TemplateColumn>
                                                                                    <asp:BoundColumn HeaderText="ID" DataField="intid"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Name" DataField="studentname"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Class" DataField="class"></asp:BoundColumn>
                                                                                    <asp:BoundColumn HeaderText="Destination" DataField="strdestination"></asp:BoundColumn>
                                                                                </Columns>

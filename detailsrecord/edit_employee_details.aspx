<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_employee_details.aspx.cs" Inherits="detailsrecord_edit_employee_details" %>
                                                ...
                                                <td style="width: 100%; height: 50px" align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0">
                                                        <tr >
                                                            ...
                                                            <td align="left" >
                                                            Edit | Delete | View Staff Details
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        ...
                                                        <tr id="menu11" style="DISPLAY: none; VISIBILITY: hidden">
                                                            <td align="left" style="height: 40px; width: 100%">
                                                                <table cellpadding="5" cellspacing="0" border="0" width="400" class="curve">
                                                        ...
                                                        <tr id="menu22" style="DISPLAY: none; VISIBILITY: hidden">
                                                            <td align="left" style="width: 100%">
                                                                <asp:UpdatePanel ID="up1" runat="server">
                                                                    <ContentTemplate>
                                                                        <table cellpadding="5" cellspacing="0" border="0" width="749" class="curve">
                                                                            <tr class="s_datagrid_header">
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" id="paneltd">
                                                                            <div id="panelid" style="overflow:auto">
                                                                                <asp:DataGrid ID="dgemployee" runat="server" Width="100%" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                                                    ...
                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <td style="height: 125px" align="left">
                                                                                                            <table cellpadding="0" cellspacing="0" border="0" >
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="width: 250px; height: 25px" class="s_gridlabel">
                                                                                                                        Teaching Subjects
                                                                                                                    </td>
                                                                                                                    <%--<td style="width: 125px; height: 25px" class="s_gridlabel">
                                                                                                                        Community
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="width: 125px; height: 25px" class="s_gridtext" valign="top">
                                                                                                                        <%#DataBinder.Eval(Container.DataItem,"dtdob") %>
                                                                                                                    </td>
                                                                                                                    <td style="width: 125px; height: 25px" class="s_gridtext" valign="top">
                                                                                                                        <%#DataBinder.Eval(Container.DataItem, "strteachsubject")%>
                                                                                                                    </td>
                                                                                                                    <%--<td style="width: 125px; height: 25px" class="s_gridtext" valign="top">
                                                                                                                        <%#DataBinder.Eval(Container.DataItem,"strcommunity")%>
                                                                                                                    </td>--%>
                                                                                                                    <td style="width: 125px; height: 25px" class="s_gridtext" valign="top">
                                                                                                                ...
                                                                                                                <tr>
                                                                                                                    ...
                                                                                                                    <td style="width: 125px; height: 25px" class="s_gridtext" valign="top">
                                                                                                                        <%#DataBinder.Eval(Container.DataItem,"strreligion") %>
                                                                                                                    </td>
                                                                                                                    <td style="width: 125px; height: 25px" class="s_gridtext" valign="top">
                                                                                        ...
                                                                                        <asp:ButtonColumn CommandName="edit" HeaderText="Edit" Text="&lt;div style=&quot;width:25px;&quot;&gt;&lt;img src=&quot;../media/images/edit.gif&quot; alt=&quot;Edit&quot; border=&quot;0&quot; /&gt;&lt;/div&gt;" HeaderStyle-HorizontalAlign="center" >
                                                                                        ...
                                                                                        <%--<asp:ButtonColumn CommandName="delete" HeaderText="Del" Text="&lt;div style=&quot;width:25px;&quot;&gt;&lt;img src=&quot;../media/images/delete.gif&quot; alt=&quot;Delete&quot; border=&quot;0&quot; /&gt;&lt;/div&gt;" HeaderStyle-HorizontalAlign="center" >
                                                                                            <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                                        </asp:ButtonColumn>--%>
                                                                                    </Columns>                                                

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_student_details.aspx.cs" Inherits="detailsrecord_edit_student_details" %>
                                ...
                                <tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        <tr>
                                                        ...
                                                        <td style="width: 100%; " align="left">
                                                            <table cellpadding="0" cellspacing="0" border="0" >
                                                                <tr>
                                                                    ...
                                                                    <td align="left" >Edit | Delete Student Details</td>                                                                 
                                                                    </tr>
                                                                </table>                                                   
                                                            </td>
                                                        </tr>
                                            ...
                                            <tr>
                                                <td style="width: 100%;padding-left: 5px; height: 20px" align="left">
                                                                ...
                                                                <tr id="trtag" runat="server">
                                                                    <td colspan="0">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">  
                                                                            ...
                                                                            <tr>
                                                                                <td style="width: 115px; height: 30px" align="left">&nbsp;&nbsp;
                                                                                    <asp:Label ID="Label6" runat="server" CssClass="s_label" Visible="false" Text="Transport"></asp:Label>
                                                                                </td>
                                                                                <td style="width: 115px; height: 30px" align="left">
                                                                                   <asp:DropDownList ID="searchbytransport" runat="server" CssClass="s_dropdown" 
                                                                                        Width="115px" AutoPostBack="True" Visible="false" 
                                                                                ...
                                                                                <td style="width: 115px; height: 30px" align="left">&nbsp;&nbsp;
                                                                                    <asp:Label ID="Label13" runat="server" CssClass="s_label" Visible="false" Text="House"></asp:Label>
                                                                                </td>
                                                                                <td style="width: 115px; height: 30px" align="left">
                                                                                    <asp:DropDownList ID="searchbyhouse" runat="server" CssClass="s_dropdown" Visible="false" 
                                                                                        Width="115px" AutoPostBack="True" 
                                                ...
                                                <td style="width: 100%; height: 100px; padding-left: 5px" valign="top" align="left">
                                                    <table cellpadding="0" cellspacing="0" border="0" class="app_container"  id="mwidth">
                                                        ...
                                                        <tr id="menu11" style="DISPLAY: none; VISIBILITY: hidden">
                                                            ...
                                                            <table cellpadding="5" cellspacing="0" border="0" width="400" class="curve" style="margin:10px;height: 40px; width: 100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" style="height:100px;" id="paneltd">
                                                                ...
                                                                <asp:DataGrid ID="dgstudetails" runat="server" AutoGenerateColumns="False" Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" oneditcommand="dgstudetails_EditCommand" CellSpacing="1" CellPadding="3">
                                                                                        ...
                                                                                        <tr valign="top">                                                                    
                                                                                            <td valign="top">                                                                    
                                                                                                <table cellpadding="0" cellspacing="0" border="0" width="130">                                                                                                
                                                                                                    <tr>
                                                                                                        <td style=" height: 30px" class="s_gridlabel" align="left">Admission No</td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                ...
                                                                <asp:ButtonColumn CommandName="edit" HeaderText="Edit" Text="&lt;img src=&quot;../media/images/edit.gif&quot; alt=&quot;Edit&quot; border=&quot;0&quot; /&gt;" HeaderStyle-HorizontalAlign="Right" >                                                                                            

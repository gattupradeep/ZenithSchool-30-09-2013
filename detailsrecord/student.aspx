<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student.aspx.cs" Inherits="school_student" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" > Add Student Details</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <table cellpadding="5" cellspacing="0" border="0" class="app_container">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" style="width: 35px; height: 40px">
                                                     <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                         CssClass="s_label" ErrorMessage="*" ControlToValidate="txtfirst"></asp:RequiredFieldValidator>--%>
                                                </td>
                                                <td align="left" style="width: 200px; height: 40px">
                                            ...
                                            <tr>
                                               <td align="left" style="width: 200px; height: 40px">
                                                ...
                                                <td align="left" style="width: 200px; height: 40px">
                                                    <asp:RadioButton ID="RBmale" runat="server" CssClass="s_label" Text="Male" 
                                            ...
                                            <tr>
                                               <td align="left" style="width: 200px; height: 40px">
                                                ...
                                                <td align="left">
                                                    ...
                                                    <%--<ajaxtoolkit:CalendarExtender ID="Calendarextender3" runat="server" CssClass="cal_Theme1" Format="yyyy/MM/dd" PopupButtonID="txtdateofreg" TargetControlID="txtdateofreg"></ajaxtoolkit:CalendarExtender >--%>
                                                </td>
                                                <td align="left" style="width: 35px; height: 40px">
                                           ...
                                           <tr>
                                               <td align="left" style="width: 200px; height: 40px">
                                                ...
                                                <td align="left" style="width: 200px; height: 40px"><asp:TextBox 
                                                    ID="txtadmitno" runat="server" CssClass="s_textbox" Width="180px" 
                                                        ontextchanged="txtadmitno_TextChanged"></asp:TextBox></td>
                                                <td style="width:35px">
                                           ...
                                           <%--<tr>
                                            ...
                                            <tr>
                                              <td align="left" style="width: 200px; height: 40px">
                                                ...
                                                <td align="left" style="height: 40px; width:200px; font-size:11px">
                                                <asp:TextBox ID="txtresidential" runat="server" CssClass="s_textbox" Width="200px" 
                                             ...
                                             <tr id="trroll" runat="server">
                                               <td align="left" style="width: 200px; height: 40px">
                                            <asp:Label ID="Label15" runat="server" CssClass="s_label" Text="Roll Number"></asp:Label>
                                                    &nbsp;</td>
                                                <td align="left">
                                                  <asp:TextBox ID="txtrollno" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                    &nbsp;</td>
                                                <td align="left" style="width: 35px; height: 40px">
                                                ...
                                                <td align="left" style="width: 200px; height: 40px">
                                                    <asp:Label ID="Label18" runat="server" CssClass="s_label" Text="Student Passort or I.C No"></asp:Label>
                                                </td>
                                                <td align="left" style="width: 200px; height: 40px">
                                                <asp:TextBox ID="txtstudentpassport" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                                <td style="width:35px">
                                                    &nbsp;</td>
                                            </tr>
                                            ...
                                            <tr>
                                               <td align="left" style="width: 200px; height: 40px">
                                                ...
                                                <td align="left" style="height: 40px; width:200px">
                                                <asp:TextBox ID="txtzipcode" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                               <td align="left" style="width: 200px; height: 40px">
                                                ...
                                                <td align="left" >
                                                    <asp:TextBox ID="txtaltmobileno" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                    <%--<asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtaltmobileno" ValidationExpression="^\d+$" runat="server" ErrorMessage="Enter number in numeric only"></asp:RegularExpressionValidator>--%>
                                                ...
                                                <td align="left" style="height: 40px; width:200px">
                                                    <asp:DropDownList ID="ddlhouse" runat="server" CssClass="s_dropdown" Width="150px"></asp:DropDownList>
                                                </td>
                                                <td style="width:35px">&nbsp;</td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="6">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <tr id="trfincome" runat="server">
                                                            <td align="left" style="width: 200px; height: 40px">
                                                               <asp:Label ID="Label93" runat="server" CssClass="s_label" Text="Father/Guardian Annual Income"></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 200px; height: 40px">
                                                              <asp:TextBox ID="txtfatherincome" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                            </td>
                                                            <td align="left" style="width: 35px; height: 40px">
                                                                &nbsp;</td>
                                                            <td align="left" style="width: 200px; height: 40px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" 
                                                        ...
                                                        <tr id="tag1" runat="server">
                                                         ...
                                                         <tr id="tag2" runat="server">
                                                            ...
                                                            <td align="left" style="height: 40px; width:200px">
                                                                <asp:DropDownList ID="ddlMstate" runat="server" AutoPostBack="True" 
                                                                    CssClass="s_dropdown" onselectedindexchanged="ddlMstate_SelectedIndexChanged" 
                                                                    Width="150px">
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td style="width:35px"></td>
                                                        ...
                                                        <tr id="tag5" runat="server">
                                                            <td align="left" style="width: 200px; height: 40px">
                                                                <asp:Label ID="Label92" runat="server" CssClass="s_label" 
                                                                    Text="Mother's Annual Income"></asp:Label>
                                                            </td>
                                                            <td  align="left" style="width: 200px; height: 40px">
                                                                <asp:TextBox ID="txtmotherincome" runat="server" CssClass="s_textbox" 
                                                                    Width="180px"></asp:TextBox>
                                                            </td>
                                                            <%--<td align="left" style="width: 35px; height: 40px">
                                                ...
                                                <td align="left" colspan="6">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">                                                         
                                                        ...
                                                        <tr id="tr2" runat="server">
                                                            ...
                                                            <td align="left" style="height: 40px; width:35px">
                                            ...
                                            <tr>
                                                <td align="center" colspan="6" style="height: 40px">
                                                    ...
                                                    <asp:Label ID="lblstudid" runat="server" Text="0" 
                                                        CssClass="s_label" Visible="False"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

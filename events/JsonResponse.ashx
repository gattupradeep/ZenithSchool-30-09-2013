...
public class JsonResponse : IHttpHandler, IRequiresSessionState 
{
    ...
    private String convertCalendarEventIntoString(CalendarEvent cevent)
    {
        ...
        return    "{" +
                  ...
                  "backgroundcolor: '" + HttpContext.Current.Server.HtmlEncode(cevent.backgroundcolor) + "'," +
                  "textcolor: '" + HttpContext.Current.Server.HtmlEncode(cevent.textcolor) + "'," +
                  "patrontype: '" + HttpContext.Current.Server.HtmlEncode(cevent.textcolor) + "'," +

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_remainder.aspx.cs" Inherits="noticeboard_editremainder" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" >Edit Reminder</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                       ...
                                       <asp:UpdateProgress ID="Updateprocess" runat="server" AssociatedUpdatePanelID="updatepanal" DisplayAfter="1" >
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Edit Reminder</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="4" style="height: 30px" align="left">
                                                    <asp:DataGrid ID="dgremainder" runat="server" AutoGenerateColumns="False"                                                                                                      
                                                        ...
                                                        oneditcommand="dgremainder_editcommand">

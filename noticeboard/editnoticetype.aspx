<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editnoticetype.aspx.cs" Inherits="noticeboard_editnoticetype" %>
                                            ...
                                            <tr>
                                                <td colspan="4" style="height: 30px" align="left">
                                                    <asp:DataGrid ID="dgnoticetype" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        oneditcommand="dgnoticetype_editcommand">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intID" HeaderText="ID" Visible="false"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strnoticename" HeaderText="Notice" ></asp:BoundColumn>

                                      ...
                                      <asp:UpdateProgress ID="Updateprocess" runat="server" AssociatedUpdatePanelID="updatepanal" DisplayAfter="1" >
                                       ...
                                       <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp;Notice Board</td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 30px" align="left">&nbsp;&nbsp;
                                                <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Notice type:"></asp:Label>
                                                    &nbsp;&nbsp; </td>
                                                <td align="left">
                                                    <asp:DropDownList ID="ddlnotice" runat="server" CssClass="s_dropdown" AutoPostBack="true"
                                                        Width="145px" onselectedindexchanged="ddlnotice_SelectedIndexChanged"></asp:DropDownList>
                                                </td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Secondaryreportcard.aspx.cs" Inherits="reportcard_Secondaryreportcard" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" > Student Secondary Report Card</td>
                                           ...
                                           <table id="student" runat="server" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="style2">
                                                    ...
                                                    <td align="left" class="style7">
                                                        &nbsp; &nbsp;<asp:Label ID="Label7" runat="server" CssClass="s_label" Text="Exam Type"></asp:Label></td>
                                                <td align="left" class="style2">
                                           ...
                                           <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                ...
                                                <tr class="view_detail_subtitle_bg">
                                                    ...
                                                    <td style="width: 150px; height:20px" align="left">
                                                        &nbsp;
                                                        <asp:Label ID="Label9" runat="server" CssClass="s_label" Text="Description"></asp:Label>
                                                        &nbsp;</td>
                                                </tr>
                                                <tr>
                                                     <td style="width: 30px; height:20px" align="center">
                                                        <asp:Label ID="Label10" runat="server" CssClass="s_label" Text="A"></asp:Label>
                                                    </td>
                                                    <td style="width: 350px; height:20px" align="left">
                                                        <asp:Label ID="Label11" runat="server" CssClass="s_label" Text="Well above the standard expected at this time of year"></asp:Label>
                                                    </td>
                                                 </tr>
                                                 <tr>   
                                                      <td style="width: 30px; height:20px" align="center">
                                                        <asp:Label ID="Label12" runat="server" CssClass="s_label" Text="B"></asp:Label>
                                                    </td>
                                                    <td style="width: 350px; height:20px" align="left">
                                                        <asp:Label ID="Label13" runat="server" CssClass="s_label" Text="Above the standard expected at this time of year"></asp:Label>
                                                    </td>
                                                  </tr>
                                                  <tr>  
                                                     <td style="width: 30px; height:20px" align="center">
                                                        <asp:Label ID="Label14" runat="server" CssClass="s_label" Text="C"></asp:Label>
                                                    </td>
                                                    <td style="width: 350px; height:20px" align="left">
                                                        <asp:Label ID="Label15" runat="server" CssClass="s_label" Text="At the standard expected at this time of year"></asp:Label>
                                                    </td>
                                                  </tr>
                                                  <tr>  
                                                     <td style="width: 30px; height:20px" align="center">
                                                        <asp:Label ID="Label16" runat="server" CssClass="s_label" Text="D"></asp:Label>
                                                    </td>
                                                    <td style="width: 350px; height:20px" align="left">
                                                        <asp:Label ID="Label17" runat="server" CssClass="s_label" Text="Below the standard expected at this time of year"></asp:Label>
                                                    </td>
                                                  </tr>
                                                  <tr>  
                                                     <td style="width: 30px; height:20px" align="center">
                                                        <asp:Label ID="Label18" runat="server" CssClass="s_label" Text="E"></asp:Label>
                                                    </td>
                                                    <td style="width: 350px; height:20px" align="left">
                                                        <asp:Label ID="Label19" runat="server" CssClass="s_label" Text="Well below the standard expected at this time of year"></asp:Label>
                                                    </td>
                                                </tr>
                                             </table>
                                             <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                               <tr id="tr3" runat="server" class="view_detail_title_bg" >
                                                   <td class="title_label" align="center" colspan="2">
                                                        <asp:Label CssClass="title_label" ID="Label20" runat="server" Text="CITIZENSHIP AND SOCIAL RESPONSIBILITY" ></asp:Label>
                                                    </td>
                                               </tr>
                                                                                        ...
                                                                                        <td style="width: 565px; height: 35px; padding-left: 15px" align="left">
                                                                                            <asp:DataGrid ID="dgdatagrid" runat="server" AutoGenerateColumns="False" 
                                                                                                ...
                                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                                    <Columns>
                                                                                                        <asp:BoundColumn DataField="strsecondindicatorexampaper" HeaderText="Exam Paper">
                                             ...
                                             <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                    <tr id="trdggrid" runat="server" class="view_detail_title_bg" >
                                                         <td class="title_label" align="center">
                                                             <asp:Label CssClass="title_label" ID="Label31" runat="server" Text="SUMMARY OF ACADEMIC PERFORMANCE" ></asp:Label>
                                                        </td>
                                                    </tr>

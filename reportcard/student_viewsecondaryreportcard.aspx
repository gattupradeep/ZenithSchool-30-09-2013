<%@ Page Language="C#" AutoEventWireup="true" CodeFile="student_viewsecondaryreportcard.aspx.cs" Inherits="reportcard_student_viewsecondaryreportcard" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                      ...
                                      <asp:UpdatePanel ID="updatepanal" runat="server" >
                                           ...
                                           <table id="student" runat="server" cellpadding="0" cellspacing="0" border="0" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="left" class="style2">
                                                   <asp:Label ID="lblteacher" runat="server" CssClass="s_label" ></asp:Label>
                                                    ...
                                                    <td align="left" class="style7">
                                                        &nbsp;
                                                    <asp:Label ID="Label43" runat="server" CssClass="s_label" Text="Student No"></asp:Label>
                                                        &nbsp;</td>
                                                <td align="left" class="style2">
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 30px" align="left">
                                                    &nbsp;
                                                    <asp:Label ID="Label44" runat="server" CssClass="s_label" Text="Exam Type"></asp:Label>
                                                    &nbsp;</td>
                                                <td align="left" class="style2">
                                          ...
                                          <table id="trindicator" runat="server" cellpadding="0" cellspacing="0" border="0" width="100%">
                                                                                        ...
                                                                                        <td style="width: 565px; height: 35px; padding-left: 15px" align="left">
                                                                                            <asp:DataGrid ID="dgdatagrid" runat="server" AutoGenerateColumns="False" 
                                                                                                ...
                                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                                    <Columns>
                                                                                                        <asp:BoundColumn DataField="strexampaper" HeaderText="Exam Paper" HeaderStyle-CssClass="title_label">
                                                                                                        <ItemStyle Width="200px" />
                                                                                                        </asp:BoundColumn>
                                                                                                         <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" HeaderText="A-Well above the standard">
                                                                                                             ...
                                                                                                             <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" HeaderText="B-Above the standard">
                                                                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                                                                <ItemStyle HorizontalAlign="Left" />
                                                                                                                    <ItemTemplate>
                                                                                                             ...
                                                                                                             <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" HeaderText="C-At the standard">
                                                                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                                                                <ItemStyle HorizontalAlign="Left" />
                                                                                                                    <ItemTemplate>
                                                                                                            ...
                                                                                                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" HeaderText="D-Below the standard">
                                                                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                                                                <ItemStyle HorizontalAlign="Left" />
                                                                                                                    <ItemTemplate>
                                                                                                             ...
                                                                                                             <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" HeaderText="E-Well below the standard">
                                                                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                                                                <ItemStyle HorizontalAlign="Left" />
                                                                                                                    <ItemTemplate>
                                             ...
                                             <table  id="trsubject1" runat="server"  cellpadding="0" cellspacing="0" border="0" width="100%">
                                                <tr class="view_detail_title_bg">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="width: 100%; height: 35px; padding-left: 15px" align="left">
                                                                                            <asp:DataGrid ID="dgexampaper" runat="server" AutoGenerateColumns="False" 
                                                                                                ...
                                                                                                <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                                                                    <Columns>
                                                                                                        <asp:BoundColumn DataField="strexampaper" HeaderText="Exam Paper" HeaderStyle-Width="150px">
                                                                                                        </asp:BoundColumn>
                                                                                                            <asp:TemplateColumn HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px" HeaderText="A-Well above the standard">
                                                                                                                <HeaderStyle HorizontalAlign="Left" />
                                                                                                                <ItemStyle HorizontalAlign="Left" />

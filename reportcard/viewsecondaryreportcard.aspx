<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewsecondaryreportcard.aspx.cs" Inherits="reportcard_viewsecondaryreportcard" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" > &nbsp;View Secondary Student Report Card</td>
                                                                                     ...
                                                                                     <tr>
                                                                                        <td style="width: 565px; height: 35px; padding-left: 15px" align="left">
                                                                                            <asp:DataGrid ID="dgdatagrid" runat="server" AutoGenerateColumns="False" 
                                                                                                BorderStyle="None" BorderWidth="0px" GridLines="None" Width="900px" 

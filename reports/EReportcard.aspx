<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EReportcard.aspx.cs" Inherits="reports_Exam_EReportcard" %>
                                                ...
                                                <td style="width: 905px; height: 20px" align="center">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style=" height: 30px" align="left">
                                                                <asp:DropDownList ID="ddlstudent" runat="server" CssClass="s_dropdown" AutoPostBack="true" 

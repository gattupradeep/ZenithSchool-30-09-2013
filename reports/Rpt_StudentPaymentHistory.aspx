<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rpt_StudentPaymentHistory.aspx.cs" Inherits="reports_Rpt_StudentPaymentHistory" %>
                                    ...
                                    <tr>
                                        <td colspan="4" style="width: 100%; padding-left: 10px" valign="top" align="center">
                                            <table cellpadding="7" style="width:80%" cellspacing="0" border="0" class="app_container_auto">
                                                ...
                                                <tr>
                                                    <td align="left" style="width:20%" class="s_label">Year </td><td align="left" style="width:20%"><asp:DropDownList ID="ddlyear" runat="server" CssClass="s_dropdown" AutoPostBack="true" Width="150px" onselectedindexchanged="ddlyear_SelectedIndexChanged" ></asp:DropDownList></td>
                                                ...
                                                <tr><td align="left" style="width:20%">&nbsp;</td><td align="right" style="width:20%"><asp:Button ID="btnclear" runat="server" CssClass="s_button" Text="Clear" onclick="btnclear_Click" /></td><td colspan="3" align="left" style="width:60%">
                                                    &nbsp;</td></tr>
                                                <tr>
                                                ...
                                                <tr><td align="center" colspan="5" style="width:98%" >
                                                    <asp:HiddenField ID="HidCyear" runat="server" />
                                                    </td></tr>
                                            </table> 
                                        </td>
                                    </tr>

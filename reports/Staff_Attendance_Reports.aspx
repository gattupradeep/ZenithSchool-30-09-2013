<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Staff_Attendance_Reports.aspx.cs" Inherits="reports_Staff_Attendance_Reports" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" >Staff Attendance Reports</td>                                                                 
                                            ...
                                            <tr>
                                                <td style="width: 905px; height: 20px" align="center">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="800">
                                                        ...
                                                        <tr>
                                                            <td style="width: 155px; height: 30px" align="left">&nbsp;&nbsp;
                                                                <asp:Label runat="server" ID="lblg" Text="Staff name :" CssClass="s_label"></asp:Label>
                                                            </td>
                                                            <td style="height: 30px;width: 235px;" align="left">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Staff_Timetable_Report.aspx.cs" Inherits="reports_Timetable_Report" %>
            ...
            <td style="width: 100%; height: 50px" align="left">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr class="app_container_title">
                        ...
                        <td align="left" >Staff Timetable Reports</td>                        
                    </tr>
                </table>
            </td>
        </tr>
                        ...
                        <td align="center">
                            <table cellpadding="5" cellspacing="0" border="0" width="905px">
                                ...
                                <tr>
                                    ...
                                    <td style=" height: 30px" align="left">
                                        <asp:DropDownList ID="ddlstaff" runat="server" CssClass="s_textbox" AutoPostBack="true" 
                                            Width="130px" onselectedindexchanged="ddlstaff_SelectedIndexChanged" ></asp:DropDownList>
                                    </td>
                                    <td>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StudentWiseAllFeeDetails.aspx.cs" Inherits="reports_StudentWiseAllFeeDetails" %>
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td style="width: 100%" valign="top" align="center">
                              <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                    <tr class="app_container_title"><td style="width: 100%; " align="left"><table cellpadding="0" cellspacing="0" border="0" ><tr><td class="app_cont_title_img_td"><img src="../images/icons/50X50/120.png" class="app_cont_title_img" alt="icon" /></td><td align="left">Student Wise Fee details Report</td></tr></table></td></tr>
                                    ...
                                    <tr>
                                        <td colspan="4" style="width: 100%; padding-left: 10px" valign="top" align="center">
                                            <table cellpadding="7" style="width:80%" cellspacing="0" border="0" class="app_container_auto">
                                                ...
                                                <tr>
                                                    <td align="left" style="width:20%" class="s_label">Intake Year &amp; Month</td><td align="left" style="width:20%"><asp:DropDownList ID="ddlyear" runat="server" CssClass="s_dropdown" AutoPostBack="true" Width="150px" onselectedindexchanged="ddlyear_SelectedIndexChanged" ></asp:DropDownList></td>
                                                    <td align="left" style="width:20%" class="s_label">Class</td><td align="left" style="width:20%"><asp:DropDownList ID="ddlclass" runat="server" AutoPostBack="True" Width="150px" onselectedindexchanged="ddlclass_SelectedIndexChanged"></asp:DropDownList></td>
                                                    <td align="left" style="width:20%"><asp:HiddenField ID="HidCyear" runat="server" /></td>
                                                </tr>
                                                <tr>
                                                    <td align="left" style="width: 20%" class="s_label">Admission No</td>
                                                    <td align="left" style="width: 20%"><asp:DropDownList ID="ddlAdmission" runat="server" AutoPostBack="True" Width="150px" onselectedindexchanged="ddlAdmission_SelectedIndexChanged"></asp:DropDownList></td>
                                                    <td align="left" style="width: 20%" class="s_label">Student Name</td>
                                                    <td colspan="2" align="left" style="width: 40%"><asp:DropDownList ID="ddlName" runat="server" AutoPostBack="True" Width="150px" onselectedindexchanged="ddlName_SelectedIndexChanged"></asp:DropDownList></td>
                                                </tr>
                                                <tr id="trMonthYeartxt" runat="server"><td align="left" class="s_label" style="width: 20%">Intake Month &amp; Year</td><td colspan="4" id="tdMonthYeartxt" runat="server" class="s_label" align="left" style="width: 80%">&nbsp;</td></tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Students_Report.aspx.cs" Inherits="reports_Students_Report" %>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td style="width: 110px; height: 50px" align="center">
                                                    <asp:Label ID="Label" runat="server" CssClass="title_label" Text="Class & Section" Width="150px" ></asp:Label>
                                                </td>
                                                 <td style="width: 110px; height: 50px" align="center">  
                                                ...
                                                <td style="width: 60px; height: 50px">
                                                    &nbsp;</td>
                                                <td style="width: 250px; height: 50px" align="center">
                                                    <asp:Label runat="server" Font-Bold="true" ID="lblg" Text="Student name" CssClass="title_label"></asp:Label>
                                                </td>
                                                <td style="width: 150px; height: 50px" align="center">    
                                                    <asp:DropDownList ID="ddlname" runat="server" CssClass="s_dropdown" Width="200px" AutoPostBack="True" onselectedindexchanged="ddlname_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        </table> 
                                                ...
                                                <td style="width: 905px; height: 20px" align="center">
                                                    <table cellpadding="0" cellspacing="0" border="0" width="800">
                                                        <tr>
                                                            ...
                                                            <td style="width: 115px; height: 30px" align="left">
                                                                <asp:DropDownList ID="searchbyadmission" runat="server" CssClass="s_dropdown" 
                                                                    Width="115px" AutoPostBack="True" 
                                                                    onselectedindexchanged="searchbyadmission_SelectedIndexChanged">                                                                                                              
                                                                </asp:DropDownList>
                                                            </td>                                                            
                                                            <td style="width: 115px; height: 30px" align="left">&nbsp;&nbsp;
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width: 115px; height: 30px" align="left" colspan="3">
                                                        ...
                                                        <tr>                                                        
                                                            <td style="width: 115px; height: 40px" align="left">&nbsp;&nbsp;
                                                                <asp:Label ID="Label4" runat="server" CssClass="s_label" Text="Date of Birth"></asp:Label>
                                                            </td>
                                                            <td colspan="3" style="height: 40px" align="left">                                                                
                                                                <asp:Label ID="Label14" runat="server" CssClass="s_label" Text="From Date :"></asp:Label>
                                                                <asp:TextBox ID="DOBfromdate" Width="100px" runat="server" CssClass="s_textbox" ></asp:TextBox>
                                                                ...
                                                                <asp:TextBox ID="DOBtodate"  Width="100px" runat="server" CssClass="s_textbox" 

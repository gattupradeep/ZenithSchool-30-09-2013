<%@ Page Language="C#" AutoEventWireup="true" CodeFile="assignexamtypes.aspx.cs" Inherits="school_assignexamtypes" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" width="750">
                                            <tr>
                                                ...
                                                <td align="left" >Assign Exam Types</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                            ...
                                            <tr>
                                                <td align="left" style="width: 175px; height: 40px">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" 
                                                        Text="Exam Types"></asp:Label>
                                                    </td>
                                                <td align="left" style="width: 150px; height: 40px">
                                                    <asp:Panel ID="Panel1" runat="server" CssClass="panel" ScrollBars="Vertical">
                                                    <asp:CheckBoxList ID="chkexamtypes" runat="server" 
                                                            onselectedindexchanged="chkexamtypes_SelectedIndexChanged" 
                                                ...
                                                <td align="left" style="width: 125px; height: 40px">
                                                    <asp:Label ID="Label14" runat="server" CssClass="s_label" 
                                                        Text="New Exam Types"></asp:Label>
                                                    </td>
                                                <td align="left" style="width: 150px; height: 40px"><asp:TextBox ID="txtaddexamtype" 
                                                        runat="server" CssClass="s_textbox" Width="150px"></asp:TextBox></td>
                                                <td align="left" style="width: 50px; height: 40px">
                                                    <asp:Button ID="btnaddexam" runat="server" Text="Add " 
                                                        onclick="btnaddexam_Click" CssClass="s_button" style="height: 26px"/>
                                                </td>
                                            </tr>                                            
                                            <tr>
                                                <td colspan="6" align="center">
                                                    <asp:Button ID="btnsave" runat="server" Text="Done" Width="100px" 
                                                        onclick="btnsave_Click1" CssClass="s_button" />
                                                </td>
                                            </tr>
                                            <tr>
                                               <td colspan="6" align="center" style="width: 60%; height: 40px">                                                                                               
                                                    <asp:DataGrid ID="dgexamorder" runat="server" AutoGenerateColumns="False"                                                     
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                        onitemdatabound="dgexamorder_ItemDataBound">
                                                        <AlternatingItemStyle cssclass="s_datagrid_alt_item" />
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intexamorderid" HeaderText="ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strexamtype" HeaderText="Examtype">
                                                            </asp:BoundColumn>
                                                            <asp:TemplateColumn HeaderText="Order No">
                                                            <ItemStyle Width="150px" />
                                                            <ItemTemplate>
                                                                <asp:DropDownList ID="ddlorderno" runat="server" Width="50px" 
                                                                    onselectedindexchanged="ddlorderno_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                                            </ItemTemplate>
                                                            </asp:TemplateColumn>
                                                            <asp:BoundColumn DataField="intorderno" HeaderText="Order" Visible="False"></asp:BoundColumn>                                                            
                                                        </Columns>

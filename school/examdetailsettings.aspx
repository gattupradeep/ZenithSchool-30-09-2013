<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examdetailsettings.aspx.cs" Inherits="school_examdetailsettings" %>
                                                ...
                                                <td colspan="2">
                                                    <table cellpadding="7" cellspacing="0" border="0" width="100%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  valign="top">
                                                            <asp:Panel ID="Panel2" runat="server" BackColor="#F7F7F7" BorderColor="#1874CD" BorderWidth="1px" Height="75px" ScrollBars="Vertical" Width="180px">
                                                                <asp:CheckBoxList ID="chkexamtype" runat="server" Height="26px" ></asp:CheckBoxList>
                                                            </asp:Panel>
                                                            </td>
                                                           </tr>
                                                        </table>

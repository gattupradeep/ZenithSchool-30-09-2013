<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewexamtypes.aspx.cs" Inherits="school_viewexamtypes" %>
                                ...
                                <tr>
                                    ...
                                    <table cellpadding="7" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg" >
                                                <td align="left">
                                                   <asp:Label CssClass="title_label" ID="lbltit" runat="server" Text="Exam Types" ></asp:Label> <asp:Label ID="lblschoolname" runat="server" CssClass="title_label_value"></asp:Label>
                                                </td>
                                                <td style="width: 85px">
                                          ...
                                          <tr>
                                            <td style="height: 50px;" class="s_label" align="left" colspan="4">
                                            <asp:BulletedList ID="blexamtypes" BulletStyle="Square" runat="server"></asp:BulletedList>
                                          <%-- <ul type="none">
                                            <li><img alt="bullet" src="../images/bullet/bull.jpg" /></li>
                                           </ul>--%>
                                           </td>
                                         </tr>
                                            </table>

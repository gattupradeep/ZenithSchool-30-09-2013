<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtimingsandperiods.aspx.cs" Inherits="school_viewtimingsandperiods" %>
                                                        ...
                                                        <tr>
                                                            <td align="left" style="width: 175px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="Label1" runat="server" CssClass="s_label" 
                                                                    Text="School Start Time " Font-Bold="True"></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 200px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="lblstarttime" runat="server" CssClass="s_label_value"></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 175px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="Label9" runat="server" CssClass="s_label" Text="School End Time" 
                                                                    Font-Bold="True"></asp:Label></td>
                                                            <td align="left" style="width: 200px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="lblschoolendtime" runat="server" CssClass="s_label_value"></asp:Label>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left" style="width: 175px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="Label2" runat="server" CssClass="s_label" Text="First Bell" 
                                                                    Font-Bold="True"></asp:Label>
                                                                </td>
                                                            <td align="left" style="width: 200px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="lblfirstbell" runat="server" CssClass="s_label_value"></asp:Label>
                                                            </td>
                                                            <td align="left" style="width: 175px; height: 40px; padding-left: 15px">
                                                              <asp:Label ID="Label26" runat="server" 
                                                                    CssClass="s_label" Font-Bold="True" Text="Periods Start Time"></asp:Label></td>
                                                            <td align="left" style="width: 200px; height: 40px; padding-left: 15px">
                                                              
                                                                <asp:Label ID="lblassemblyend" runat="server" CssClass="s_label_value"></asp:Label>
                                                                </td>
                                                        </tr>
                                                        <tr id="trassembly" runat="server">
                                                            <td id="tr" runat="server" align="left" style="width: 175px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="Label3" runat="server" CssClass="s_label" 
                                                                    Text="Assembly Start Time" Font-Bold="True"></asp:Label>
                                                                </td>
                                                            <td align="left" style="width: 200px; height: 40px; padding-left: 15px">
                                                                <asp:Label ID="lblassembly" runat="server" CssClass="s_label_value"></asp:Label>
                                                                </td>
                                                            <td align="left" style="width: 175px; height: 40px; padding-left: 15px">
                                                             <asp:Label ID="Label10" runat="server" CssClass="s_label" Text="Second Bell" 
                                                                    Font-Bold="True"></asp:Label>
                                                                &nbsp;</td>
                                                            <td align="left" style="width: 200px; height: 40px; padding-left: 15px">  
                                                            <asp:Label ID="lblsecondbell" runat="server" CssClass="s_label_value"></asp:Label>                                                                                                                                                                                                 
                                                                &nbsp;</td>
                                                        </tr>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Lessoncomplete.aspx.cs" Inherits="student_Lessoncomplete" %>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%"  >
                                                        ...
                                                        <tr>
                                                            <td style="height: 40px" align="center"  width="100%">
                                                                ...
                                                                CellPadding="3" oneditcommand="dglessons_EditCommand" OnItemDataBound="dglessons_ItemDataBound">
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:BoundColumn DataField="intcompleted" Visible="false"></asp:BoundColumn>
                                                                        <asp:TemplateColumn HeaderText="Status" >
                                                                            <ItemTemplate>
                                                                                <asp:Button ID="btnstatus" runat="server" CausesValidation="false" CommandName="edit" 
                                                                                    Text="Compeleted" CssClass="s_grdbutton" />
                                                                            </ItemTemplate>
                                                                        </asp:TemplateColumn>
                                                                    </Columns>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewassignedsubstitute.aspx.cs" Inherits="substitute_viewassignedsubstitute" %>
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td style="height: 40px">
                                                    <table cellpadding="5" cellspacing="0" border="0">
                                                        <tr>
                                                            <td style="width: 120px; height: 40px;" align="left" class="header_lable">
                                                                <asp:Label ID="lbltitle" runat="server">Staff Name</asp:Label>
                                                            </td>
                                                            ...
                                                            <td style="width: 120px;" align="left" class="header_lable">
                                                                <asp:Label ID="lbltitle0" runat="server">Date</asp:Label>
                                                            </td>
                                                            <td style="width: 180px; height: 40px; padding-left: 15px">
                                                            ...
                                                            <td style="width: 120px; height: 40px" align="center">
                                                                <asp:Button ID="btnupdate" runat="server" CssClass="s_button" Text="Reset" 
                                                            ...
                                                            <asp:TemplateColumn HeaderText="Assign Substitute">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:Button id="btnassign"  runat="server" CausesValidation="false" 
                                                                        ...
                                                                        Text="View" Font-Bold="True" onclick="btnassign_Click"  />
                                                                </ItemTemplate>
                                                             </asp:TemplateColumn>
                                                        </Columns>

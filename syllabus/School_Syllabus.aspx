                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr id="trtextbook" runat="server" visible="false">
                                               ...
                                               <td style="width: 250px; height: 40px" align="left" >
                                                ...
                                                <td style="width: 150px; height: 40px" align="left">
                                                    &nbsp;
                                                     <asp:Label ID="Label4" runat="server" CssClass="s_label" Text="Author Name"></asp:Label>
                                                </td>
                                                <td style="width: 250px; height: 40px" align="left">
                                                    <asp:Label ID="lblauthor" runat="server" CssClass="s_label"></asp:Label><asp:Label ID="lblsame" runat="server" CssClass="s_label" Visible="False"></asp:Label>
                                                </td>
                                           </tr>
                                           <tr>

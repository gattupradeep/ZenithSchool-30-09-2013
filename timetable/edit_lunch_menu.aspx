<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_lunch_menu.aspx.cs" Inherits="timetable_edit_lunch_menu" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" >Edit Lunch Menu Time Table</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="2"><asp:Label ID="lbltitle" runat="server" Text="Edit Food Menu" CssClass="title_label"></asp:Label></td>
                                            </tr>
                                            <tr style="height:40px">
                                                <td align="left">&nbsp;&nbsp;
                                                    <asp:Label ID="day" runat="server" Text="Day" 
                                                ...
                                                <td  style="height: 40px" colspan="2">
                                                     <asp:DataGrid ID ="dglunchmenu" runat="server" CellPadding="4" 
                                                        AutoGenerateColumns="False"  Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None"  
                                                         oneditcommand="dglunch_EditCommand">

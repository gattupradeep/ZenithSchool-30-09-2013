<%@ Page Language="C#" AutoEventWireup="true" CodeFile="setlanguage.aspx.cs" Inherits="timetable_setlanguage" %>
    ...
    <div>
        <table cellpadding="0" cellspacing="0" width="450" class="curve" align="center">
            <tr class="timetable_daysheader" >
                <td style="height: 40px; padding-left: 10px" align="left" class="title_label">
            ...
            <tr>
                <td style="height: 30px;width:100%;" align="left" colspan="4">
                    <asp:DataGrid ID="dg2" runat="server" AutoGenerateColumns="False" 
                        BorderStyle="None" BorderWidth="0px" GridLines="None" Width="450px" 
                        onitemdatabound="dg2_ItemDataBound" >
                        <AlternatingItemStyle CssClass="s_datagrid_alt_item"/>
                        <ItemStyle CssClass="s_datagrid_item"/>
                            <Columns>
                                <asp:BoundColumn DataField="strteacher" HeaderText="Teacher" Visible="false"></asp:BoundColumn>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                ...
                                <asp:TemplateColumn HeaderText="Section" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                ...
                                <asp:TemplateColumn HeaderText="Teacher" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">

<HeaderStyle HorizontalAlign="Center"></HeaderStyle>

                                <ItemStyle Width="150px" />
                                <ItemTemplate>
                                <asp:DropDownList ID="ddlteacher" runat="server" Width="150px"  CssClass="s_dropdown"></asp:DropDownList>
                                </ItemTemplate>
                                </asp:TemplateColumn>
                                <asp:BoundColumn DataField="strstandard" HeaderText="standard" Visible="false"></asp:BoundColumn>
                                <asp:BoundColumn DataField="strsection" HeaderText="section" Visible="false"></asp:BoundColumn>
                            </Columns>

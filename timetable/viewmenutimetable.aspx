<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewmenutimetable.aspx.cs" Inherits="timetable_viewmenutimetable" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left" > View Menu Time Table</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="2"><asp:Label ID="lbltitle" runat="server" Text="View Food Menu" CssClass="title_label"></asp:Label></td>
                                            </tr>
                                            <tr>

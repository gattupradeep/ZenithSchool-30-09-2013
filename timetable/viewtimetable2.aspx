<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viewtimetable2.aspx.cs" Inherits="timetable_viewtimetable" %>
            ...
            <td style="width: 100%; height: 400px" align="left" valign="top">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                        ...
                        <td style="width: 94%" valign="top" align="left" id="mwidth">
                            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="width: 100%; height: 100px; padding-left: 5px" valign="top" align="left" id="paneltd">
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:ImageButton ID="btnsunsecond" runat="server" 
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:Label ID="lblmonsub" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "strsubject")%>'>
                                                                                                </asp:Label>
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:Label ID="lbltuesub" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "strsubject")%>'>
                                                                                                </asp:Label>
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:Label ID="lblwedsub" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "strsubject")%>'>
                                                                                                </asp:Label>
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:Label ID="lblthusub" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "strsubject")%>'>
                                                                                                </asp:Label>
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:Label ID="lblfrisub" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "strsubject")%>'>
                                                                                                </asp:Label>
                                                                                    ...
                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="151">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td style="height: 90px; width:150px;padding-left: 10px" align="center" class="s_label">
                                                                                                ...
                                                                                                <asp:Label ID="lblsatsub" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "strsubject")%>'>
                                                                                                </asp:Label>

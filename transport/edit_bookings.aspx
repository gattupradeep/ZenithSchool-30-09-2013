<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_bookings.aspx.cs" Inherits="transport_edit_bookings" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left"> Edit/Delete&nbsp; Bus Booking</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" class="app_container">
                                            <tr class="view_detail_title_bg">
                                                <td class="title_label">&nbsp;Edit/Delete&nbsp; Bus Booking</td>
                                            </tr>
                                            <tr>
                                                <td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left" >
                                                                <asp:DropDownList ID="ddldestination" runat="server" CssClass="s_dropdown" 
                                                                 Width="150px" onselectedindexchanged="ddldestination_SelectedIndexChanged" 
                                                                    AutoPostBack="True">                                                     
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td align="left" >
                                                                <asp:Label ID="Label14" runat="server" CssClass="s_label" Text="Pickuptime : "></asp:Label>
                                                                <asp:Label ID="lblpickup" runat="server" CssClass="s_label" Text="0"></asp:Label>
                                                            </td>
                                                            <td align="left" >
                                                                <asp:Label ID="Label16" runat="server" CssClass="s_label" Text="Dropuptime : "></asp:Label>
                                                         ...
                                                         <tr>
                                                            <td align="center" >
                                                                &nbsp;</td>
                                                            <td align="center" >
                                                                <asp:Button ID="btnbook" runat="server" CssClass="s_button" Text="Book" 
                                                                    Width="75px" onclick="btnbook_Click"/>
                                                ...
                                                <td style="width: 750px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgasgnbusroute" runat="server" AutoGenerateColumns="False"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strroutename" HeaderText="Route No" ></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strdrivername" HeaderText="Driver Name"></asp:BoundColumn>
                                                            ...
                                                            <asp:BoundColumn DataField="intstudentid" HeaderText="Student" Visible="false">
                                                            </asp:BoundColumn>
                                                            <asp:ButtonColumn HeaderText="Edit" Text="&lt;img src=&quot;../media/images/edit.gif&quot; alt=&quot;Edit&quot; border=&quot;0&quot; /&gt;" 
                                                                CommandName="edit">
                                                            </asp:ButtonColumn>
                                                            ...
                                                            <%--<asp:ButtonColumn HeaderText="Delete" Text="&lt;img src=&quot;../media/images/delete.gif&quot; alt=&quot;Delete&quot; border=&quot;0&quot; /&gt;" 
                                                                CommandName="delete">
                                                            </asp:ButtonColumn>--%>
                                                            </Columns>

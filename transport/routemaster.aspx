<%@ Page Language="C#" AutoEventWireup="true" CodeFile="routemaster.aspx.cs" Inherits="transport_routemaster" %>
                                    ...
                                    <td style="width: 100%; " align="left">
                                        <table cellpadding="0" cellspacing="0" border="0" >
                                            <tr>
                                                ...
                                                <td align="left"> Add / Edit Route</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 10px" valign="top" align="left">
                                        <asp:UpdateProgress ID="Updateprocess" runat="server" AssociatedUpdatePanelID="updatepanal" DisplayAfter="1" >
                                            ...
                                            <tr class="view_detail_title_bg">
                                                <td colspan="4" class="title_label">&nbsp; Add / Edit Route</td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <table cellpadding="7" cellspacing="0" border="0" width="100%">
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="left">
                                                                <asp:Label ID="Label2" runat="server" CssClass="s_label" Text="Route Name"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                                <asp:TextBox ID="txtroutename" runat="server" CssClass="s_textbox" 
                                                        ...
                                                        <tr>
                                                            <td style="width: 150px; height: 40px" align="left">
                                                                <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Driver"></asp:Label>
                                                            </td>
                                                            <td style="width: 200px; height: 40px" align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left" class="style1">
                                                                <asp:Label ID="Label3" runat="server" CssClass="s_label" Text="Vehicle "></asp:Label>
                                                            </td>
                                                            <td align="left" class="style2">
                                                                <asp:DropDownList ID="ddlvehicle" runat="server" CssClass="s_dropdown" 
                                                                 Width="150px">                                                     
                                                                </asp:DropDownList>
                                                            </td>
                                                            <td align="left" class="style1">
                                                        ...
                                                        <tr>
                                                            <td align="left" class="style1">
                                                                <asp:Label ID="Label4" runat="server" CssClass="s_label" Text="Starts At"></asp:Label>
                                                            </td>
                                                            <td align="left" class="style2">
                                                                <asp:TextBox ID="txtstartsat" runat="server" CssClass="s_textbox" 
                                                                    Width="180px"></asp:TextBox>
                                                            </td>
                                                            <td align="left" class="style1">
                                                                &nbsp;</td>
                                            ...
                                            <tr>
                                                <td colspan="4" style=" height: 40px" align="left">
                                                    <asp:DataGrid ID="dgroute" runat="server" AutoGenerateColumns="False"
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                        oneditcommand="dgroute_EditCommand">
                                                        <AlternatingItemStyle CssClass ="s_datagrid_alt_item" />
                                                        <ItemStyle CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intID" HeaderText="ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strroutename" HeaderText="Route Name" 
                                                            ...
                                                            <asp:BoundColumn DataField="strdrivername" HeaderText="Driver"  
                                                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intdriver" HeaderText="Driver" Visible="false"
                                                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intvehicle" HeaderText="Vehicle"  Visible="false" 
                                                                ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                                <ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strstartsat" HeaderText="Starts At">
                                                            </asp:BoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="welcome.aspx.cs" Inherits="transport_welcome" %>
                                            ...
                                            <tr>
                                                <td style="width: 710px; height: 400px" align="center">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_textbox" Font-Bold="True" 
                                                        Font-Size="30px" ForeColor="Red" Text="Welcome to Transport Management"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>

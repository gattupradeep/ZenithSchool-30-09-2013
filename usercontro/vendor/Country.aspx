                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtcountryname" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                                                        ControlToValidate="txtcountryname" ErrorMessage="*">*</asp:RequiredFieldValidator>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label2" runat="server" CssClass="s_label" 
                                                        Text="Floor Type"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtfloortype" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                                        ControlToValidate="txtfloortype" ErrorMessage="*">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label3" runat="server" CssClass="s_label" 
                                                        Text="ISD Code"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtisdcode" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                                        ControlToValidate="txtisdcode" ErrorMessage="*">*</asp:RequiredFieldValidator>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="left">
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtcurrencycode" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                                                        ControlToValidate="txtcurrencycode" ErrorMessage="*">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="4" style="width: 700px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgcountry" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dgcountry_DeleteCommand"
                                                     OnEditCommand="dgcountry_EditCommand" Width="100%" BorderStyle="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="countryname" HeaderText="Country Name">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strfloortype" HeaderText="Floor Type">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="intcode" HeaderText="ISD Code"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strcurrency" HeaderText="Currency">
                                                            </asp:BoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="board.aspx.cs" Inherits="admin_Admin_board" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Board Name"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtboard" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                                ...
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgboard" runat="server" AutoGenerateColumns="False" 
                                                        ...
                                                        <ItemStyle BackColor="#DEEDFF" Font-Names="Verdana" Font-Size="11px" 
                                                            Height="25px" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="ID" HeaderText="Board ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="boardname" HeaderText="Board Name">
                                                            </asp:BoundColumn>

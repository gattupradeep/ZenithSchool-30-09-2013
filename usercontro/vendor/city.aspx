<%@ Page Language="C#" AutoEventWireup="true" CodeFile="city.aspx.cs" Inherits="vendor_city" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 50px" valign="top" align="left">
                                       <asp:UpdateProgress ID="Updateprocess" runat="server" AssociatedUpdatePanelID="updatepanal" DisplayAfter="1" >
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="700">
                                            <tr>
                                                <td colspan="4" style="width: 700px; height: 20px" align="right">
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtcity" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label4" runat="server" CssClass="s_label" 
                                                        Text="STD Code"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtstdcode" runat="server" CssClass="s_textbox" 
                                                        Width="180px"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="4" style="width: 700px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgcountry" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dgcountry_DeleteCommand"
                                                     OnEditCommand="dgcountry_EditCommand" Width="60%" BorderStyle="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="intcode" HeaderText="STD Code">
                                                            </asp:BoundColumn>

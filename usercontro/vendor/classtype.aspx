<%@ Page Language="C#" AutoEventWireup="true" CodeFile="classtype.aspx.cs" Inherits="vendor_classtype" %>
                                         ...
                                         <asp:UpdateProgress ID="Updateprocess" runat="server" AssociatedUpdatePanelID="updatepanal" DisplayAfter="1" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Class Type"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtstandardtype" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgstandardtype" runat="server" AutoGenerateColumns="False" 
                                                        OnDeleteCommand="dgclasstype_DeleteCommand" OnEditCommand="dgclasstype_EditCommand" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strclasstype" HeaderText="Class Type">
                                                            </asp:BoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="competitions.aspx.cs" Inherits="vendor_competitions" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" 
                                                        Text="Competition Type"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtcompetition" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgcompetition" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dgcompetition_DeleteCommand"
                                                     OnEditCommand="dgcompetition_EditCommand" Width="100%" BorderStyle="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strcompetitiontype" HeaderText="Competition Type">
                                                            </asp:BoundColumn>

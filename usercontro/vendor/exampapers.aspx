<%@ Page Language="C#" AutoEventWireup="true" CodeFile="exampapers.aspx.cs" Inherits="vendor_exampapers" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtexampaper" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgexampaper" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dgexampaper_DeleteCommand"
                                                     OnEditCommand="dgexampaper_EditCommand" Width="100%" BorderStyle="None" 

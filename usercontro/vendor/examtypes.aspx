<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examtypes.aspx.cs" Inherits="vendor_examtypes" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtexamtype" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgexamtype" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dgexamtype_DeleteCommand"
                                                     OnEditCommand="dgexamtype_EditCommand" Width="100%" BorderStyle="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strexamtype" HeaderText="Exam Type">
                                                            </asp:BoundColumn>

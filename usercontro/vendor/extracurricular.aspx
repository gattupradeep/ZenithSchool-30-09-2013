<%@ Page Language="C#" AutoEventWireup="true" CodeFile="extracurricular.aspx.cs" Inherits="vendor_extracurricular" %>
                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="750">
                                            <tr>
                                                ...
                                                <td style="width: 685px; height: 50px; font-family: Arial; font-size: 23px; color: #2DA0ED; padding-left: 10px" align="left">
                                                    Add / Edit Extra Curricular Activity</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" 
                                                        Text="Extra Curricular Activity"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtextracurricular" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgextracurricular" runat="server" 
                                                        AutoGenerateColumns="False"  OnDeleteCommand="dgextracurricular_DeleteCommand"
                                                     OnEditCommand="dgextracurricular_EditCommand" Width="100%" BorderStyle="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strextracurricular" 
                                                                HeaderText="Extra Curricular Activity">
                                                            </asp:BoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="group.aspx.cs" Inherits="vendor_group" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Group Name"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtgroup" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dggroup" runat="server" AutoGenerateColumns="False"                                                     
                                                        Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None" 
                                                        ondeletecommand="dggroup_DeleteCommand" 
                                                        oneditcommand="dggroup_EditCommand">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strgroup" HeaderText="Group">
                                                            </asp:BoundColumn>

                                        ...
                                        <table cellpadding="0" cellspacing="0" border="0" width="700">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txthousename" runat="server" CssClass="s_textbox" 
                                                        Height="28px" Width="197px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="3" style="width: 500px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dghouse" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dghouse_DeleteCommand"

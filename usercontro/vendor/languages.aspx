<%@ Page Language="C#" AutoEventWireup="true" CodeFile="languages.aspx.cs" Inherits="vendor_languages" %>
                                         ...
                                         <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Language"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtlanguage" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dglanguage" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dglanguage_DeleteCommand"
                                                     OnEditCommand="dglanguage_EditCommand" Width="100%" BorderStyle="None" BorderWidth="0px" GridLines="None">
                                                        <AlternatingItemStyle CssClass="s_datagrid_alt_item" />
                                                        <ItemStyle 
                                                            Height="25px" CssClass="s_datagrid_item" />
                                                        <Columns>
                                                            <asp:BoundColumn DataField="intid" HeaderText=" ID" Visible="False"></asp:BoundColumn>
                                                            <asp:BoundColumn DataField="strlanguagename" HeaderText="Language">
                                                            </asp:BoundColumn>
                                                ...
                                                <td style="width: 150px; height: 30px" align="left" valign="bottom"></td>

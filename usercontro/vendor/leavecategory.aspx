<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leavecategory.aspx.cs" Inherits="school_leavecategory" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Category name"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtcategory" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgcategory" runat="server" AutoGenerateColumns="False" 
                                                        OnDeleteCommand="dgcategory_DeleteCommand" OnEditCommand="dgcategory_EditCommand" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strleavecategory" HeaderText="Categoryname">
                                                            </asp:BoundColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="sections.aspx.cs" Inherits="admin_Admin_sections" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Section Name:"></asp:Label>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgboard" runat="server" AutoGenerateColumns="False"                                                     
                                                        ...
                                                        ondeletecommand="dgboard_DeleteCommand" 

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="standard.aspx.cs" Inherits="vendor_standard" %>
                                          ...
                                          <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtstandard" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgstandard" runat="server" AutoGenerateColumns="False"                                                     
                                                        ...
                                                        ondeletecommand="dgstandard_DeleteCommand" 

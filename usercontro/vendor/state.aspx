<%@ Page Language="C#" AutoEventWireup="true" CodeFile="state.aspx.cs" Inherits="vendor_state" %>
                                    ...
                                    <td style="width: 100%; height: 100px; padding-left: 50px" valign="top" align="left">
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtstate" runat="server" CssClass="s_textbox" 
                                            ...
                                            <tr>
                                                <td colspan="4" style="width: 700px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgcountry" runat="server" AutoGenerateColumns="False"  OnDeleteCommand="dgcountry_DeleteCommand"
                                                     OnEditCommand="dgcountry_EditCommand" Width="50%" BorderStyle="None" 
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strstate" HeaderText="State">
                                                            </asp:BoundColumn>
                                                            <asp:BoundColumn DataField="countryid" HeaderText="Country ID" Visible="False">
                                                            </asp:BoundColumn>

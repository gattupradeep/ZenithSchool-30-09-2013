<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vehiclecategory.aspx.cs" Inherits="transport_vehiclecategory" %>
                                        ...
                                        <asp:UpdatePanel ID="updatepanal" runat="server" >
                                            ...
                                            <tr>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:Label ID="Label1" runat="server" CssClass="s_label" Text="Vehicle Category"></asp:Label>
                                                </td>
                                                <td style="width: 200px; height: 40px" align="left">
                                                    <asp:TextBox ID="txtvehicle" runat="server" CssClass="s_textbox" Width="180px"></asp:TextBox>
                                                </td>
                                                <td style="width: 150px; height: 40px" align="left">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
                                                        ControlToValidate="txtvehicle" ErrorMessage="*" Height="16px" Width="16px"></asp:RequiredFieldValidator>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="2" style="width: 350px; height: 40px" align="left">
                                                    <asp:DataGrid ID="dgvehicle" runat="server" AutoGenerateColumns="False"                                                       
                                                        ...
                                                        ondeletecommand="dgvehicle_DeleteCommand" oneditcommand="dgvehicle_EditCommand">
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundColumn DataField="strvehiclecategory" HeaderText="Vehicle Category">
                                                            </asp:BoundColumn>

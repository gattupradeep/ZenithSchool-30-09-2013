<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Welcome_teacher.aspx.cs" Inherits="welcome_Welcome_teacher" %>
                                                        ...
                                                        <tr>
                                                            <td style="width: 560px; height: 400px" valign="top" align="left">
                                                                <table cellpadding="0" cellspacing="0" border="0" width="550">
                                                                    ...
                                                                    <tr>
                                                                        <td style="width: 550px; height: 1px; background-color: #b3b3b3"></td>
                                                                    </tr>
                                                                    <tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 60px; height: 30px" valign="top" align="left">
                                                                                        <asp:ImageButton ImageUrl="../media/images/rightarrow.gif" 
                                                                                            ID="btntimetable2marrow" runat="server" onclick="btntimetable2marrow_Click" /><br />&nbsp;<asp:Label ID="lbltimetable2marrow" runat="server"></asp:Label></td>
                                                                                </tr>
                                                                                <tr>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                         ...
                                                                                                         <tr>
                                                                                                            <td align="right" class="s_label" style="width:420px" colspan="2">
                                                                                                                 ...
                                                                                                                 <asp:DropDownList ID="ddlSclass" runat="server" CssClass="s_dropdown1" Width="85px" AutoPostBack="True" onselectedindexchanged="ddlSclass_SelectedIndexChanged">                                                                                                                     
                                                                                                                 </asp:DropDownList>
                                                                                                ...
                                                                                                <ContentTemplate>
                                                                                                    <table cellpadding="0" cellspacing="0" border="0" width="420">
                                                                                                        <tr>
                                                                                                            ...
                                                                                                            <td style="width: 60px; height: 30px" valign="top" align="right"><asp:ImageButton ID="btnHyesterday" runat="server" ImageUrl="../media/images/leftarrow.gif" onclick="btnHyesterday_Click" />
                                                                                                                &nbsp;&nbsp;
                                                                                                                <br />
                                                                                                                Yesterday&nbsp;&nbsp; </td>
                                                                                                            <td style="width: 60px; height: 30px" valign="top" align="left">
                                                                                                              <asp:ImageButton ID="btnHtommorow" runat="server" ImageUrl="../media/images/rightarrow.gif" onclick="btnHtommorow_Click"/><br />
                                                                                                                &nbsp;Tomorrow
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td style="width: 420px; height: 50px" colspan="3">
                                                                                                                  <asp:DataGrid ID="dghomework" runat="server" CellPadding="4" 
                                                                                                                    ...
                                                                                                                    <PagerStyle Visible="False" />                                                                                                                    
                                                                                                                    <Columns>
                                                                                                                       <asp:BoundColumn DataField="strstandard" HeaderText="Standard" ItemStyle-Font-Names="Verdana" ItemStyle-Font-Size="10px"></asp:BoundColumn>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td align="right" class="s_label" style="width:420px" colspan="2">
                                                                                                                <asp:Label ID="lblselect0" runat="server" Text="Select"></asp:Label>
                                                                                                                <asp:DropDownList ID="ddlHclass" runat="server" CssClass="s_dropdown1" 
                                                                                                                    Width="85px" AutoPostBack="True" 
                                                                                                                    onselectedindexchanged="ddlHclass_SelectedIndexChanged"></asp:DropDownList>
                                                                                                                <asp:DropDownList ID="ddlHsubject" runat="server" CssClass="s_dropdown1" 
                                                                                                                    Width="100px" AutoPostBack="True" 
                                                                                                                    onselectedindexchanged="ddlHsubject_SelectedIndexChanged" ></asp:DropDownList>
                                                                                                         </td>
                                                                                                       </tr>                                                                                                       
                                                                                                    </table>
                                                                                                </ContentTemplate>
                                                                                                        ...
                                                                                                        <table cellpadding="0" cellspacing="0" border="0" width="180">
                                                                                                           <%-- <tr>
                                                                                                                <td style="font-weight:bold; color:Black; font-size:11px;">
                                                                                                                    <%# DataBinder.Eval(Container, "DataItem.remainder_end")%>
                                                                                                                </td>
                                                                                                            </tr>--%>
                                                                                                            <tr>
                                                                                                                <td style="font-weight:bold; color:Black; font-size:11px;">
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0" border="0" width="192">
                                                                                ...
                                                                                <tr>
                                                                                    <td colspan="3" style="width: 192px; height: 50px;" class="s_text" valign="top">
                                                                                       ...
                                                                                       <asp:Label ID="lblthisweek" runat="server" CssClass="s_label"></asp:Label></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td colspan="3" style="width: 192px; height: 10px;" class="s_text" valign="top">
                                                                                    </td>

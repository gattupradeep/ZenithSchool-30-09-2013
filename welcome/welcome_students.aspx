<%@ Page Language="C#" AutoEventWireup="true" CodeFile="welcome_students.aspx.cs" Inherits="welcome_welcome_students" %>
                                                        ...
                                                        <tr>
                                                            <td style="width: 560px; height: 400px" valign="top" align="left">
                                                                <table cellpadding="0" cellspacing="0" border="0" width="550">
                                                                    ...
                                                                    <tr><td style="width: 550px; height: 10px"></td></tr>
                                                                    <tr id="trhidepreschool1" runat="server"><td style="width: 550px; height: 10px; background-image: url(../media/images/line1.png)"></td></tr>
                                                                    <tr><td style="width: 550px; height: 10px"></td></tr>
                                                                    <tr id="trhidepreschool2" runat="server">
                                                                        <td style="width: 550px; height: 100px" valign="top">
                                                                            <table cellpadding="0" cellspacing="0" border="0" width="550">
                                                                                <tr>
                                                                                                    ...
                                                                                                    <ContentTemplate>
                                                                                                        ...
                                                                                                        <tr>
                                                                                                            <td style="width: 420px; height: 50px" colspan="3">                                                                                                                
                                                                                                                ...
                                                                                                                <asp:Label ID="lblsheduledate1" runat="server" CssClass="s_label" ForeColor="Black"></asp:Label>                                                                                                            
                                                                                                            </td>
                                                                                                        </tr>
                                                                                                        <tr>
                                                                                                            <td align="right" class="s_label" style="width:420px" colspan="2">
